title: "22.4 — std::move – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/stdmove/
...
[*Alex*][1] March 4, 2017, 8:21 pm PST May 8, 2024
...
There is a useful variant of `std::move()` called `std::move_if_noexcept()` that returns a movable r-value if the object has a `noexcept` move constructor, otherwise it returns a copyable l-value. We cover this in lesson [27.10 -- std::move_if_noexcept][2].
...
22.3Move constructors and move assignment

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/stdmove_if_noexcept/
  [3]: https://www.learncpp.com/cpp-tutorial/stdunique_ptr/
