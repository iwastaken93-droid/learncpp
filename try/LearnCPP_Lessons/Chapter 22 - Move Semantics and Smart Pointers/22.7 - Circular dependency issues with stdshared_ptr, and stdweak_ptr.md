title: "22.7 — Circular dependency issues with std::shared_ptr, and std::weak_ptr – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/circular-dependency-issues-with-stdshared_ptr-and-stdweak_ptr/
...
# 22.7 â€" Circular dependency issues with std::shared_ptr, and std::weak_ptr

[*Alex*][1] March 21, 2017, 5:44 pm PDT July 22, 2024
...
22.6std::shared_ptr
  ...
  [5]: https://www.learncpp.com/cpp-tutorial/stdshared_ptr/
