title: "22.2 — R-value references – Learn C++"
...
# 22.2 â€" R-value references

[*Alex*][1] February 20, 2017, 2:49 pm PST May 15, 2024

In chapter 12, we introduced the concept of value categories ([12.2 -- Value categories (lvalues and rvalues)][2]), which is a property of expressions that helps determine whether an expression resolves to a value, function, or object. We also introduced l-values and r-values so that we could discuss l-value references.
