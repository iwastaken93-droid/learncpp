title: "28.3 — Output with ostream and ios – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/output-with-ostream-and-ios/
...
# 28.3 â€" Output with ostream and ios

[*Alex*][1] March 12, 2008, 3:10 pm PDT March 16, 2024

In this section, we will look at various aspects of the iostream output class (ostream).

**The insertion operator**

The insertion operator (\<\<) is used to put information into an output stream. C++ has predefined insertion operations for all of the built-in data types, and you've already seen how you can [overload the insertion operator][2] for your own classes.

In the lesson on [streams][3], you saw that both istream and ostream were derived from a class called ios. One of the jobs of ios (and ios_base) is to control the formatting options for output.
...
28.4Stream classes for strings

Back to table of contents

Previous lesson

28.2Input with istream
