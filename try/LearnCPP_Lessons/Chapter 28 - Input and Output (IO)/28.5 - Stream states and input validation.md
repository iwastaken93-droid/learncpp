title: "28.5 — Stream states and input validation – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/stream-states-and-input-validation/
...
# 28.5 â€" Stream states and input validation

[*Alex*][1] March 25, 2008, 3:21 pm PDT September 9, 2024
...
Reader "Waldo� provides a C++20 solution (using std::ranges) that addresses these shortcomings [here][3]
...
Here is the code:
    ...
    bool inputMatches(std::string_view input, std::string_view pattern)
    {
        ...
        // Before C++20, use
        // return std::equal(input.begin(), input.end(), pattern.begin(), -> bool {
        // ...
        return std::ranges::equal(input, pattern, -> bool {
