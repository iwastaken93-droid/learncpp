title: "28.1 — Input and output (I/O) streams – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/input-and-output-io-streams/
...
# 28.1 â€" Input and output (I:O) streams

[*Alex*][1] February 28, 2008, 4:10 pm PST September 11, 2023
...
When you include the iostream header, you gain access to a whole hierarchy of classes responsible for providing I/O functionality (including one class that is actually named iostream). You can find a class hierarchy diagram for the non-file-I/O classes [here][2].
