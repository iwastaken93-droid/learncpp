title: "12.5 — Pass by lvalue reference – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/pass-by-lvalue-reference/
...
# 12.5 â€" Pass by lvalue reference

[*Alex*][1] July 24, 2007, 6:06 pm PDT December 6, 2024

In the previous lessons, we introduced lvalue references ([12.3 -- Lvalue references][2]) and lvalue references to const ([12.4 -- Lvalue references to const][3]). In isolation, these may not have seemed very useful -- why create an alias to a variable when you can just use the variable itself?
...
First, some context. Back in lesson [2.4 -- Introduction to function parameters and arguments][4] we discussed `pass by value`, where an argument passed to a function is copied into the function's parameter:
