title: "12.4 — Lvalue references to const – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/lvalue-references-to-const/
...
[*Alex*][1] June 7, 2017, 3:30 pm PDT February 23, 2025

In the previous lesson ([12.3 -- Lvalue references][2]), we discussed how an lvalue reference can only bind to a modifiable lvalue. This means the following is illegal:
...
We covered temporary objects in lesson [2.5 -- Introduction to local scope][3].
...
Although it may seem strange to allow this, we'll see examples where this is useful in lesson [12.6 -- Pass by const lvalue reference][4].
...
We show an example of this in lesson [12.12 -- Return by reference and return by address][5].
