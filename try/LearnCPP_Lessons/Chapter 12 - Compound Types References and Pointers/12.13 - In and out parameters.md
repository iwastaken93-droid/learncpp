title: "12.13 — In and out parameters – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/in-and-out-parameters/
...
# 12.13 â€" In and out parameters

[*Alex*][1] July 31, 2023, 11:22 am PDT December 9, 2024
...
[This answer on StackOverflow][2] is an interesting read that explains why non-const lvalue references are not allowed to bind to rvalues/temporary objects (due to implicit type conversion producing unexpected behavior when combined with out-parameters).
