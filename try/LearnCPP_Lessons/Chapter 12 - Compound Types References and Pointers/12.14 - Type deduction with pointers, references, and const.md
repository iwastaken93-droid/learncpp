title: "12.14 — Type deduction with pointers, references, and const – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/type-deduction-with-pointers-references-and-const/
...
# 12.14 â€" Type deduction with pointers, references, and const

[*Alex*][1] February 2, 2022, 2:56 pm PST January 21, 2025

In lesson [10.8 -- Type deduction for objects using the auto keyword][2], we discussed how the `auto` keyword can be used to have the compiler deduce the type of a variable from the initializer:
...
This is covered in lesson [12.4 -- Lvalue references to const][3].
