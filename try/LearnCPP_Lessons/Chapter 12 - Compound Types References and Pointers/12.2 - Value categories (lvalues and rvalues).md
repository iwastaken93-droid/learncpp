title: "12.2 — Value categories (lvalues and rvalues) – Learn C++"
...
[*Alex*][1] January 18, 2022, 10:04 am PST January 3, 2025
...
In lesson [1.10 -- Introduction to expressions][2], we defined an expression as "a combination of literals, variables, operators, and function calls that can be executed to produce a singular value�.
...
In lesson [6.4 -- Increment/decrement operators, and side effects][3], we also noted that expressions can produce side effects that outlive the expression:
...
A full list of lvalue and rvalue expressions can be found [here][4]. In C++11, rvalues are broken into two subtypes: prvalues and xvalues, so the rvalues we're talking about here are the sum of both of those categories.
...
We cover array decay in lesson [17.8 -- C-style array decay][5].
