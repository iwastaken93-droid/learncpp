title: "12.1 — Introduction to compound data types – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/introduction-to-compound-data-types/
...
# 12.1 â€" Introduction to compound data types

[*Alex*][1] January 18, 2022, 10:01 am PST November 23, 2024

In lesson [4.1 -- Introduction to fundamental data types][2], we introduced the fundamental data types, which are the basic data types that C++ provides as part of the core language.
