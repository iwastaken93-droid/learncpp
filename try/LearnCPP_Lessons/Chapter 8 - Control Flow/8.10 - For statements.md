title: "8.10 — For statements – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/for-statements/
...
# 8.10 â€" For statements

[*Alex*][1] June 25, 2007, 6:48 pm PDT February 19, 2025
...
As of C++11, there are two different kinds of for-loops. We'll cover the classic for-statement in this lesson, and the newer range-based for-statement in a future lesson ([16.8 -- Range-based for loops (for-each)][2]) once we've covered some other prerequisite topics.
...
Note that the end-expression executes *after* the loop statement, and then the condition is re-evaluated.
...
We cover the comma operator in lesson [6.5 -- The comma operator][3].
...
[Fizz Buzz][5] is a simple math game used to teach children about divisibility. It is also sometimes used as an interview question to assess basic programming skills.
...
8.11Break and continue

Back to table of contents

Previous lesson

8.9Do while statements

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/range-based-for-loops-for-each/
  [3]: https://www.learncpp.com/cpp-tutorial/the-comma-operator/
  [4]: javascript:void(0)
  [5]: https://en.m.wikipedia.org/wiki/Fizz_buzz
  [6]: https://www.learncpp.com/cpp-tutorial/break-and-continue/
  [7]: https://www.learncpp.com/
  [8]: https://www.learncpp.com/cpp-tutorial/do-while-statements/
