title: "8.12 — Halts (exiting your program early) – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/halts-exiting-your-program-early/
...
# 8.12 â€" Halts (exiting your program early)

[*Alex*][1] December 21, 2020, 11:26 am PST December 28, 2024
...
We discuss passing functions as arguments in lesson [20.1 -- Function Pointers][2].
...
We will see cases in future lesson [9.6 -- Assert and static_assert][3] where `std::abort` is called implicitly.
...
8.11Break and continue
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/function-pointers/
  [3]: https://www.learncpp.com/cpp-tutorial/assert-and-static_assert/
  [4]: https://www.learncpp.com/cpp-tutorial/introduction-to-random-number-generation/
