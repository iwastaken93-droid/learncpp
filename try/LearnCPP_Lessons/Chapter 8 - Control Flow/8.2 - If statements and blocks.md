title: "8.2 — If statements and blocks – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/if-statements-and-blocks/
...
[*Alex*][1] June 21, 2007, 10:01 am PDT March 5, 2025
...
C++ supports two basic kinds of conditionals: `if statements` (which we introduced in lesson [4.10 -- Introduction to if statements][2], and will talk about further here) and `switch statements` (which we'll cover in a couple of lessons).
...
8.3Common if statement problems

Back to table of contents

Previous lesson

8.1Control flow introduction

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/introduction-to-if-statements/
  [3]: https://www.learncpp.com/cpp-tutorial/common-if-statement-problems/
  [4]: https://www.learncpp.com/
  [5]: https://www.learncpp.com/cpp-tutorial/control-flow-introduction/
