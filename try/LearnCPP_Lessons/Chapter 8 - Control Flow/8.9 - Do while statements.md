title: "8.9 — Do while statements – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/do-while-statements/
...
# 8.9 â€" Do while statements

[*Alex*][1] June 25, 2007, 4:54 pm PDT February 5, 2025
...
But this only works because our initial value of `0` for `selection` isn't in the set of valid values (`1, 2, 3 or 4`). What if `0` was a valid choice? We'd have to pick a different initializer to represent "invalid� -- and now we're introducing magic numbers ([5.2 -- Literals][2]) into our code.
...
8.8Introduction to loops and while statements
  ...
  [5]: https://www.learncpp.com/cpp-tutorial/introduction-to-loops-and-while-statements/
