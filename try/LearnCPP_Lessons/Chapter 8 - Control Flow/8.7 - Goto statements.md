title: "8.7 — Goto statements – Learn C++"
...
[*Alex*][1] June 21, 2007, 6:55 pm PDT October 14, 2024
...
Use of `goto` is shunned in C++ (and other modern high level languages as well). [Edsger W. Dijkstra][3], a noted computer scientist, laid out the case for avoiding goto in a famous but difficult to read paper called [Go To Statement Considered Harmful][4]. The primary problem with goto is that it allows a programmer to jump around the code arbitrarily. This creates what is not-so-affectionately known as spaghetti code. **Spaghetti code** is code that has a path of execution that resembles a bowl of spaghetti (all tangled and twisted), making it extremely difficult to follow the logic of such code.
...
8.8Introduction to loops and while statements
...
8.6Switch fallthrough and scoping
  ...
  [2]: https://www.learncpp.com#Chapter7
  [3]: https://en.wikipedia.org/wiki/Edsger_Dijkstra
  [4]: http://www.cs.utexas.edu/users/EWD/ewd02xx/EWD215.PDF
  [5]: https://xkcd.com/292/
  [6]: https://imgs.xkcd.com/comics/goto.png
  [7]: https://www.learncpp.com/cpp-tutorial/introduction-to-loops-and-while-statements/
  [8]: https://www.learncpp.com/
  [9]: https://www.learncpp.com/cpp-tutorial/switch-fallthrough-and-scoping/
