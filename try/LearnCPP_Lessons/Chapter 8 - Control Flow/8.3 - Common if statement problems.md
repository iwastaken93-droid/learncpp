title: "8.3 — Common if statement problems – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/common-if-statement-problems/
...
[*Alex*][1] December 21, 2020, 11:18 am PST December 29, 2024

This lesson is a continuation of lesson [8.2 -- If statements and blocks][2]. In this lesson, we'll take a look at some common problems that occur when using if-statements.
...
Nested if-statements can often be flattened by either restructuring the logic or by using logical operators (covered in lesson [6.8 -- Logical operators][3]). Code that is less nested is less error prone.
...
8.2If statements and blocks
  ...
  [3]: https://www.learncpp.com/cpp-tutorial/logical-operators/
  [4]: https://www.learncpp.com/cpp-tutorial/constexpr-if-statements/
