title: "8.11 — Break and continue – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/break-and-continue/
...
# 8.11 â€" Break and continue

[*Alex*][1] June 26, 2007, 4:22 pm PDT September 11, 2023

Break

Although you have already seen the `break` statement in the context of `switch` statements ([8.5 -- Switch statement basics][2]), it deserves a fuller treatment since it can be used with other types of control flow statements as well. The **break statement** causes a while loop, do-while loop, for loop, or switch statement to end, with execution continuing with the next statement after the loop or switch being broken out of.
...
See lesson [8.6 -- Switch fallthrough and scoping][3] for more information about fallthrough, along with some additional examples.
...
8.10For statements
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/switch-statement-basics/
  [3]: https://www.learncpp.com/cpp-tutorial/switch-fallthrough-and-scoping/
  [4]: https://www.learncpp.com/cpp-tutorial/halts-exiting-your-program-early/
  [5]: https://www.learncpp.com/
  [6]: https://www.learncpp.com/cpp-tutorial/for-statements/
