title: "8.6 — Switch fallthrough and scoping – Learn C++"
...
[*Alex*][1] December 21, 2020, 11:20 am PST September 1, 2024

This lesson continues our exploration of switch statements that we started in the prior lesson [8.5 -- Switch statement basics][2]. In the prior lesson, we mentioned that each set of statements underneath a label should end in a `break statement` or a `return statement`.
...
8.5Switch statement basics

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/switch-statement-basics/
  [3]: javascript:void(0)
  [4]: https://www.learncpp.com/cpp-tutorial/goto-statements/
