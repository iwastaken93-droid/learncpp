title: "8.13 — Introduction to random number generation – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/introduction-to-random-number-generation/
...
# 8.13 â€" Introduction to random number generation

[*Alex*][1] February 18, 2022, 1:56 pm PST August 26, 2024
...
Over the years, many different kinds of PRNG algorithms have been developed (Wikipedia has a good list [here][2]). Every PRNG algorithm has strengths and weaknesses that might make it more or less suitable for a particular application, so selecting the right algorithm for your application is important.
...
A test called [PracRand][3] is often used to assess the performance and quality of PRNGs (to determine whether they have different kinds of biases). You may also see references to SmallCrush, Crush or BigCrush -- these are other tests that are sometimes used for the same purpose.

If you want to see what the output of Pracrand looks like, [this website][4] has output for all of the PRNGs that C++ supports as of C++20.
...
However, it's worth noting that by modern PRNG standards, Mersenne Twister is [a bit outdated][5]. The biggest issue with Mersenne Twister is that its results can be predicted after seeing 624 generated numbers, making it non-suitable for any application that requires non-predictability.
...
- The [Xoshiro family][6] and [Wyrand][7] for non-cryptographic PRNGs.
- The [Chacha family][8] for cryptographic (non-predictable) PRNGs.
...
8.14Generating random numbers using Mersenne Twister

Back to table of contents

Previous lesson

8.12Halts (exiting your program early)

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://en.wikipedia.org/wiki/List_of_random_number_generators
  [3]: http://pracrand.sourceforge.net/
  [4]: https://arvid.io/2018/06/30/on-cxx-random-number-generator-quality/
  [5]: https://en.wikipedia.org/wiki/Mersenne_Twister#Characteristics
  [6]: https://prng.di.unimi.it/
  [7]: https://github.com/wangyi-fudan/wyhash
  [8]: https://cr.yp.to/chacha.html
  [9]: https://www.learncpp.com/
  [10]: https://www.learncpp.com/cpp-tutorial/halts-exiting-your-program-early/
