title: "1.2 — Comments – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/comments/
...
[*Alex*][1] May 30, 2007, 4:17 pm PDT March 19, 2025
...
We discuss commenting for variable declaration statements in lesson [1.7 -- Keywords and naming identifiers][2].
...
Documentation generation programs such as [Doxygen][3] are designed to help generate and leverage documentation in various ways. Amongst other things, they can:
...
If you do need to comment out a code block that contains multi-line comments, you can also consider using the `#if 0` preprocessor directive, which we discuss in lesson [2.10 -- Introduction to the preprocessor][4].
...
1.1Statements and the structure of a program
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/keywords-and-naming-identifiers/
  [3]: https://www.doxygen.nl/
  [4]: https://www.learncpp.com/cpp-tutorial/introduction-to-the-preprocessor/#if0
  [5]: https://www.learncpp.com/cpp-tutorial/introduction-to-objects-and-variables/
  [6]: https://www.learncpp.com/
  [7]: https://www.learncpp.com/cpp-tutorial/statements-and-the-structure-of-a-program/
