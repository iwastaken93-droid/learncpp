title: "1.10 — Introduction to expressions – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/introduction-to-expressions/
...
[*Alex*][1] June 6, 2007, 8:15 am PDT February 15, 2025
...
- An object or a function. We discuss expressions that return objects in lesson [12.2 -- Value categories (lvalues and rvalues)][2].
- Nothing. These are the result of non-value returning function calls (covered in lesson [2.3 -- Void functions (non-value returning functions)][3]) that are called only for their side effects
...
We cover side effects in lesson [1.9 -- Introduction to literals and operators][4]).
...
1.9Introduction to literals and operators
  ...
  [3]: https://www.learncpp.com/cpp-tutorial/void-functions-non-value-returning-functions/
  [4]: https://www.learncpp.com/cpp-tutorial/introduction-to-literals-and-operators/
  [5]: javascript:void(0)
  [6]: https://www.learncpp.com/cpp-tutorial/developing-your-first-program/
