title: "1.1 — Statements and the structure of a program – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/statements-and-the-structure-of-a-program/
...
[*Alex*][1] May 30, 2007, 7:10 am PDT March 17, 2025
...
We discuss the outputting of characters and text in lesson [1.5 -- Introduction to iostream: cout, cin, and endl][2].  
We discuss characters (including control characters) in more detail in lesson [4.11 -- Chars][3].
...
If you run into issues compiling or executing this program, check out lesson [0.8 -- A few common C++ problems][4].
...
Hint: Review lesson [0.5 -- Introduction to the compiler, linker, and libraries][6]
...
0.13What language standard is my compiler using?
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/introduction-to-iostream-cout-cin-and-endl/
  ...
  [7]: https://www.learncpp.com/cpp-tutorial/comments/
