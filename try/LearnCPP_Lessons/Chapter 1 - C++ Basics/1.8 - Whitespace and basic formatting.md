title: "1.8 — Whitespace and basic formatting – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/whitespace-and-basic-formatting/
...
# 1.8 â€" Whitespace and basic formatting

[*Alex*][1] June 1, 2007, 5:22 pm PDT January 23, 2024
...
There are also external tools that can be used to automatically format code. [clang-format][2] is a popular one.
...
- [C++ Core Guidelines][3], maintained by Bjarne Stroustrup and Herb Sutter.
- [Google][4].
- [LLVM][5]
- [GCC/GNU][6]
...
1.7Keywords and naming identifiers
  ...
  [5]: https://llvm.org/docs/CodingStandards.html
  [6]: https://gcc.gnu.org/codingconventions.html
  [7]: https://www.learncpp.com/cpp-tutorial/introduction-to-literals-and-operators/
  [8]: https://www.learncpp.com/
  [9]: https://www.learncpp.com/cpp-tutorial/keywords-and-naming-identifiers/
