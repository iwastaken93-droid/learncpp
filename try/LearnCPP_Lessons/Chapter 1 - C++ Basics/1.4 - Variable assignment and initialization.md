title: "1.4 — Variable assignment and initialization – Learn C++"
...
# 1.4 â€" Variable assignment and initialization

[*Alex*][1] February 1, 2019, 9:49 am PST March 6, 2025

In the previous lesson ([1.3 -- Introduction to objects and variables][2]), we covered how to define a variable that we can use to store values. In this lesson, we'll explore how to actually put values into variables.
...
We cover the rest of the differences between copy-initialization, direct-initialization, and list-initialization in lesson [14.15 -- Class initialization and copy elision][3].

For advanced readers

Other forms of initialization include:

- Aggregate initialization (see [13.8 -- Struct aggregate initialization][4]).
- Copy-list-initialization (discussed below).
- Reference initialization (see [12.3 -- Lvalue references][5]).
- Static-initialization, constant-initialization, and dynamic-initialization (see [7.8 -- Why (non-const) global variables are evil][6]).
...
We'll discuss this case further in lesson ([1.6 -- Uninitialized variables and undefined behavior][7]).
...
Additionally, list-initialization also provides a way to initialize objects with a list of values rather than a single value (which is why it is called "list-initialization�). We show an example of this in lesson [16.2 -- Introduction to std::vector and list constructors][8].
...
For more discussion on this topic, Bjarne Stroustrup (creator of C++) and Herb Sutter (C++ expert) make this recommendation themselves [here][10].

We explore what happens if you try to use a variable that doesn't have a well-defined value in lesson [1.6 -- Uninitialized variables and undefined behavior][7].
...
1.3Introduction to objects and variables
  ...
  [4]: https://www.learncpp.com/cpp-tutorial/struct-aggregate-initialization/
  [5]: https://www.learncpp.com/cpp-tutorial/lvalue-references/
  [6]: https://www.learncpp.com/cpp-tutorial/why-non-const-global-variables-are-evil/
  [7]: https://www.learncpp.com/cpp-tutorial/uninitialized-variables-and-undefined-behavior/
  [8]: https://www.learncpp.com/cpp-tutorial/introduction-to-stdvector-and-list-constructors/
  [9]: https://isocpp.github.io/CppCoreGuidelines/CppCoreGuidelines#Res-list
  [10]: https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md#es20-always-initialize-an-object
  [11]: javascript:void(0)
  [12]: https://www.learncpp.com/cpp-tutorial/introduction-to-iostream-cout-cin-and-endl/
