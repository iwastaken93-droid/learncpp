title: "26.5 — Partial template specialization – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/partial-template-specialization/
...
# 26.5 â€" Partial template specialization

[*Alex*][1] August 17, 2008, 6:59 pm PDT March 16, 2024
...
In lesson [26.2 -- Template non-type parameters][2], you learned how expression parameters could be used to parameterize template classes.
...
(We covered std::strcpy in lesson [17.10 -- C-style strings][3] if you need a refresher)
...
So how do we get around this? One obvious way is to partially specialize the entire class:
    ...
    public:
        ...
        const double& operato const { return m_array[index]; }
        double& operato { return m_array[index]; }
        void print() const;
    };
...
26.6Partial template specialization for pointers

Back to table of contents

Previous lesson

26.4Class template specialization

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/template-non-type-parameters/
  [3]: https://www.learncpp.com/cpp-tutorial/c-style-strings/
  [4]: https://www.learncpp.com/cpp-tutorial/partial-template-specialization-for-pointers/
  [5]: https://www.learncpp.com/
  [6]: https://www.learncpp.com/cpp-tutorial/class-template-specialization/
