title: "26.4 — Class template specialization – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/class-template-specialization/
date: 2026-04-01 03:31
tags: 
description: 
...
# 26.4 â€" Class template specialization

[*Alex*][1] August 16, 2008, 2:25 pm PDT July 5, 2024

In the previous lesson [26.3 -- Function template specialization][2], we saw how it was possible to specialize functions in order to provide different functionality for specific data types. As it turns out, it is not only possible to specialize functions, it is also possible to specialize classes!
...
All of the other changes are just class implementation details. You do not need to understand how the bit-logic works in order to use the class (though you can review [O.2 -- Bitwise operators][3] if you want to figure it out, but need a refresher on how bitwise operators work).
...
As noted in the prior lesson ([26.3 -- Function template specialization][2]), explicit function specializations are not implicitly inline, so we should mark our specialization of `Storage<double>::print()` as inline if it is defined it in a header file.
...
26.5Partial template specialization
...
26.3Function template specialization
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/function-template-specialization/
  [3]: https://www.learncpp.com/cpp-tutorial/bitwise-operators/
  [4]: https://www.learncpp.com/cpp-tutorial/partial-template-specialization/
