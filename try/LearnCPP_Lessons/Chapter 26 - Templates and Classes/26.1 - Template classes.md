title: "26.1 — Template classes – Learn C++"
...
# 26.1 â€" Template classes

[*Alex*][1] June 16, 2008, 8:04 pm PDT July 23, 2024
...
In the lesson on [23.6 -- Container classes][3], you learned how to use composition to implement classes that contained multiple instances of other classes. As one example of such a container, we took a look at the IntArray class. Here is a simplified example of that class:
...
Array.h:
    ...
    public:
        ...
        T& operato; // now returns a T&
        int getLength() const { return m_length; }
    };
    // member functions defined outside the class need their own template declaration
    template <typename T>
    T& Array<T>::operato // now returns a T&
    {
        assert(index >= 0 && index < m_length);
        return m_data[index];
    }
...
The above program will compile, but cause a linker error:
    ...
    undefined reference to `Array<int>::operato'
...
26.2Template non-type parameters
...
25.xChapter 25 summary and quiz
  ...
  [3]: https://www.learncpp.com/cpp-tutorial/container-classes/
  [4]: https://www.learncpp.com/cpp-tutorial/template-non-type-parameters/
  [5]: https://www.learncpp.com/
  [6]: https://www.learncpp.com/cpp-tutorial/chapter-25-summary-and-quiz/
