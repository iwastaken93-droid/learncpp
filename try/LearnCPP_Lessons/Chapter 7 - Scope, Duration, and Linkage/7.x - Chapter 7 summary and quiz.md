title: "7.x — Chapter 7 summary and quiz – Learn C++"
...
# 7.x â€" Chapter 7 summary and quiz

[*Alex*][1] May 9, 2015, 11:06 am PDT December 2, 2024
...
Both of these shortcomings can be addressed using functors ([21.10 -- Overloading the parenthesis operator][3]) instead of a static local variable.
...
7.14Unnamed and inline namespaces
  ...
  [4]: https://www.learncpp.com/cpp-tutorial/control-flow-introduction/
