title: "7.3 — Local variables – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/local-variables/
...
# 7.3 â€" Local variables

[*Alex*][1] March 23, 2015, 11:32 am PDT June 9, 2024

In lesson [2.5 -- Introduction to local scope][2], we introduced `local variables`, which are variables that are defined inside a function (including function parameters).
...
Please review lesson [7.1 -- Compound statements (blocks)][3] if you need a refresher on blocks.
...
We discuss what a lifetime is in lesson [2.5 -- Introduction to local scope][2].
...
We discuss what happens when variables with the same name appear in nested blocks in lesson [7.5 -- Variable shadowing (name hiding)][4].
...
7.4Introduction to global variables

Back to table of contents

Previous lesson

7.2User-defined namespaces and the scope resolution operator

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/introduction-to-local-scope/
  [3]: https://www.learncpp.com/cpp-tutorial/compound-statements-blocks/
  [4]: https://www.learncpp.com/cpp-tutorial/variable-shadowing-name-hiding/
  [5]: javascript:void(0)
  [6]: https://www.learncpp.com/cpp-tutorial/introduction-to-global-variables/
