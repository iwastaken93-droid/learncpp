title: "7.10 — Sharing global constants across multiple files (using inline variables) – Learn C++"
...
# 7.10 â€" Sharing global constants across multiple files (using inline variables)

[*Alex*][1] January 3, 2020, 10:41 am PST December 14, 2024
...
2.  Inside this header file, define a namespace (discussed in lesson
...
In lesson [7.9 -- Inline functions and variables][2], we covered inline variables, which are variables that can have more than one definition, so long as those definitions are identical. By making our constexpr variables inline, we can define them in a header file and then \#include them into any .cpp file that requires them. This avoids both ODR violations and the downside of duplicated variables.
...
Use `std::string_view` for `constexpr` strings. We cover this in lesson [5.8 -- Introduction to std::string_view][3].

Related content

We summarize the scope, duration, and linkage of various kinds of variables in lesson [7.12 -- Scope, duration, and linkage summary][4].

Next lesson

7.11Static local variables

Back to table of contents

Previous lesson

7.9Inline functions and variables

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/inline-functions-and-variables/
  [3]: https://www.learncpp.com/cpp-tutorial/introduction-to-stdstring_view/
  [4]: https://www.learncpp.com/cpp-tutorial/scope-duration-and-linkage-summary/
