title: "7.7 — External linkage and variable forward declarations – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/external-linkage-and-variable-forward-declarations/
...
[*Alex*][1] January 3, 2020, 10:40 am PST December 11, 2024

In the prior lesson ([7.6 -- Internal linkage][2]), we discussed how `internal linkage` limits the use of an identifier to a single file. In this lesson, we'll explore the concept of `external linkage`.
...
- Deduplicate inline identifiers so one canonical definition remains. We discuss inline variables and functions in lesson [7.9 -- Inline functions and variables][3].

Functions have external linkage by default

In lesson [2.8 -- Programs with multiple code files][4], you learned that you can call a function defined in one file from another file. This is because functions have external linkage by default.
...
We provide a comprehensive summary in lesson [7.12 -- Scope, duration, and linkage summary][5].
...
7.6Internal linkage
  ...
  [3]: https://www.learncpp.com/cpp-tutorial/inline-functions-and-variables/
  [4]: https://www.learncpp.com/cpp-tutorial/programs-with-multiple-code-files/
  [5]: https://www.learncpp.com/cpp-tutorial/scope-duration-and-linkage-summary/
  [6]: javascript:void(0)
  [7]: https://www.learncpp.com/cpp-tutorial/why-non-const-global-variables-are-evil/
