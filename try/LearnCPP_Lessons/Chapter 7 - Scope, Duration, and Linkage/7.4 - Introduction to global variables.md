title: "7.4 — Introduction to global variables – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/introduction-to-global-variables/
...
- It helps prevent inadvertent name shadowing (we discuss this point further in lesson [7.5 -- Variable shadowing (name hiding)][3]).
...
We sometimes get feedback from readers asking whether prefixes such as `g_` are okay because they've been told that prefixes are a form of [Hungarian notation][4] and "Hungarian notation is bad�.
...
7.3Local variables
  ...
  [3]: https://www.learncpp.com/cpp-tutorial/variable-shadowing-name-hiding/
  [4]: https://en.wikipedia.org/wiki/Hungarian_notation
  [5]: https://www.learncpp.com/cpp-tutorial/why-non-const-global-variables-are-evil/
