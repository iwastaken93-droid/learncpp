title: "7.5 — Variable shadowing (name hiding) – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/variable-shadowing-name-hiding/
...
[*Alex*][1] January 3, 2020, 11:01 am PST July 18, 2024
...
GCC and Clang support the flag `-Wshadow` that will generate warnings if a variable is shadowed. There are several subvariants of this flag (`-Wshadow=global`, `-Wshadow=local`, and `-Wshadow=compatible-local`. Consult the [GCC documentation][2] for an explanation of the differences.
...
7.4Introduction to global variables
  ...
  [3]: https://www.learncpp.com/cpp-tutorial/internal-linkage/
  [4]: https://www.learncpp.com/
  [5]: https://www.learncpp.com/cpp-tutorial/introduction-to-global-variables/
