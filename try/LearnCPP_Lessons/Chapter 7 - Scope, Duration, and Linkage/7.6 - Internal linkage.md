title: "7.6 — Internal linkage – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/internal-linkage/
...
[*Alex*][1] January 3, 2020, 10:37 am PST January 30, 2025

In lesson [7.3 -- Local variables][2], we said, "An identifier's linkage determines whether other declarations of that name refer to the same object or not�, and we discussed how local variables have `no linkage`.

Global variables and function identifiers can have either `internal linkage` or `external linkage`. We'll cover the internal linkage case in this lesson, and the external linkage case in lesson [7.7 -- External linkage and variable forward declarations][3].
...
We cover translation units in lesson [2.10 -- Introduction to the preprocessor][4].
...
In lesson [2.7 -- Forward declarations and definitions][5], we noted that the one-definition rule says that an object or function can't have more than one definition, either within a file or a program.
...
We cover unnamed namespaces in lesson [7.14 -- Unnamed and inline namespaces][6].
...
We provide a comprehensive summary in lesson [7.12 -- Scope, duration, and linkage summary][7].

Next lesson

7.7External linkage and variable forward declarations

Back to table of contents

Previous lesson

7.5Variable shadowing (name hiding)

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/local-variables/
  [3]: https://www.learncpp.com/cpp-tutorial/external-linkage-and-variable-forward-declarations/
  [4]: https://www.learncpp.com/cpp-tutorial/introduction-to-the-preprocessor/
  [5]: https://www.learncpp.com/cpp-tutorial/forward-declarations/
  [6]: https://www.learncpp.com/cpp-tutorial/unnamed-and-inline-namespaces/
  [7]: https://www.learncpp.com/cpp-tutorial/scope-duration-and-linkage-summary/
  [8]: https://www.learncpp.com/
  [9]: https://www.learncpp.com/cpp-tutorial/variable-shadowing-name-hiding/
