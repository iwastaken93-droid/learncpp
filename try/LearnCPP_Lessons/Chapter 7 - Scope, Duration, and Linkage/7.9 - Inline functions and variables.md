title: "7.9 — Inline functions and variables – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/inline-functions-and-variables/
...
[*Alex*][1] July 30, 2007, 3:16 pm PDT January 18, 2025
...
We cover internal linkage in lesson [7.6 -- Internal linkage][2] and external linkage in lesson [7.7 -- External linkage and variable forward declarations][3].
...
We show a practical example where inline is used for a random number generation header-only library in lesson [8.15 -- Global random numbers (Random.h)][4].

For advanced readers

The following functions are implicitly inline:

- Functions defined inside a class, struct, or union type definition ([14.3 -- Member functions][5]).
- Constexpr / consteval functions ([F.1 -- Constexpr functions][6]).
- Functions implicitly instantiated from function templates ([11.7 -- Function template instantiation][7]).
...
- Static constexpr data members [15.6 -- Static member variables][8].
...
7.10Sharing global constants across multiple files (using inline variables)

Back to table of contents

Previous lesson

7.8Why (non-const) global variables are evil
  ...
  [4]: https://www.learncpp.com/cpp-tutorial/global-random-numbers-random-h/
  [5]: https://www.learncpp.com/cpp-tutorial/member-functions/
  [6]: https://www.learncpp.com/cpp-tutorial/constexpr-functions/
  ...
  [10]: https://www.learncpp.com/cpp-tutorial/why-non-const-global-variables-are-evil/
