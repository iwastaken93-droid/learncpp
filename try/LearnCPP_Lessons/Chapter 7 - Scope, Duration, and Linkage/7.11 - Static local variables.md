title: "7.11 — Static local variables – Learn C++"
...
# 7.11 â€" Static local variables

[*Alex*][1] June 19, 2007, 5:46 pm PDT December 26, 2024
...
In lesson [2.5 -- Introduction to local scope][2], you learned that local variables have automatic duration by default, which means they are created at the point of definition, and destroyed when the block is exited.
...
In cases where you need multiple instances of a non-const variable that remembers its value (e.g. to have multiple ID generators), a functor is a good solution (see lesson [21.10 -- Overloading the parenthesis operator][3]).
...
7.10Sharing global constants across multiple files (using inline variables)
  ...
  [3]: https://www.learncpp.com/cpp-tutorial/overloading-the-parenthesis-operator/
  [4]: javascript:void(0)
