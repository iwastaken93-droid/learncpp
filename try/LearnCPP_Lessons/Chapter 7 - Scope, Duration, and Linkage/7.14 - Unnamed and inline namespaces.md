title: "7.14 — Unnamed and inline namespaces – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/unnamed-and-inline-namespaces/
...
# 7.14 â€" Unnamed and inline namespaces

[*Alex*][1] January 3, 2020, 1:12 pm PST November 26, 2024
...
Unnamed namespaces should generally not be used in header files. [SEI CERT (rule DCL59-CPP)][2] has some good examples as to why.
...
7.13Using declarations and using directives

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://wiki.sei.cmu.edu/confluence/display/cplusplus/DCL59-CPP.+Do+not+define+an+unnamed+namespace+in+a+header+file
  [3]: https://www.learncpp.com/cpp-tutorial/chapter-7-summary-and-quiz/
  [4]: https://www.learncpp.com/
  [5]: https://www.learncpp.com/cpp-tutorial/using-declarations-and-using-directives/
