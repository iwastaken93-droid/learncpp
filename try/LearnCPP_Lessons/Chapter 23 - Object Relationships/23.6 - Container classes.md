title: "23.6 — Container classes – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/container-classes/
...
# 23.6 â€" Container classes

[*Alex*][1] December 14, 2007, 4:54 pm PST December 30, 2024
...
Container classes generally come in two different varieties. **Value containers** are [compositions][2] that store copies of the objects that they are holding (and thus are responsible for creating and destroying those copies). **Reference containers** are [aggregations][3] that store pointers or references to other objects (and thus are not responsible for creation or destruction of those objects).
...
- When performing resize or insertion operations, move elements only if their move constructor is noexcept, otherwise copy them ([27.10 -- std::move_if_noexcept][4]).
- Provide a strong exception safety guarantee for resize or insertion operations ([27.9 -- Exception specifications and noexcept][5]).
...
23.5Dependencies
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/102-composition/
  [3]: https://www.learncpp.com/cpp-tutorial/103-aggregation/
  [4]: https://www.learncpp.com/cpp-tutorial/stdmove_if_noexcept/
  [5]: https://www.learncpp.com/cpp-tutorial/exception-specifications-and-noexcept/
  [6]: https://www.learncpp.com/cpp-tutorial/stdinitializer_list/
  [7]: https://www.learncpp.com/
  [8]: https://www.learncpp.com/cpp-tutorial/dependencies/
