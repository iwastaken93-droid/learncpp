title: "10.5 — Arithmetic conversions – Learn C++"
...
# 10.5 â€" Arithmetic conversions

[*Alex*][1] June 17, 2021, 5:40 pm PDT November 11, 2024

In lesson [6.1 -- Operator precedence and associativity][2], we discussed how expressions are evaluated according to the precedence and associativity of their operators.
...
You can find the full rules for the usual arithmetic conversions [here][4].
...
We'll show an example where this is useful in lesson [11.8 -- Function templates with multiple template types][5].
