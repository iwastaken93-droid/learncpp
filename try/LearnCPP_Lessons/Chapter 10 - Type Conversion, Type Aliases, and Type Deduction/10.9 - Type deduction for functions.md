title: "10.9 — Type deduction for functions – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/type-deduction-for-functions/
...
# 10.9 â€" Type deduction for functions

[*Alex*][1] June 17, 2021, 5:42 pm PDT December 18, 2024
...
We discuss this case a bit more (and how to express the actual return type of such a function) in lesson [11.8 -- Function templates with multiple template types][2].
...
1.  The trailing return syntax is also required for some advanced features of C++, such as lambdas (which we cover in lesson [20.6 -- Introduction to lambdas (anonymous functions)][3]).
...
We introduce function templates in lesson [11.6 -- Function templates][4], and discuss use of `auto` in the context of function templates in lesson [11.8 -- Function templates with multiple template types][2].
...
10.8Type deduction for objects using the auto keyword
