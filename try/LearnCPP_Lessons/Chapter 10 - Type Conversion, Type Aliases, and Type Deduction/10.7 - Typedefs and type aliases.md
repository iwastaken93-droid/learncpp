title: "10.7 — Typedefs and type aliases – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/typedefs-and-type-aliases/
...
[*Alex*][1] June 19, 2007, 9:04 pm PDT February 11, 2024
...
The fixed-width integer types (such as `std::int16_t` and `std::uint32_t`) and the `size_t` type (both covered in lesson [4.6 -- Fixed-width integers and size_t][4]) are actually just type aliases to various fundamental types.
...
10.6Explicit type conversion (casting) and static_cast

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://en.wikipedia.org/wiki/POSIX
  [3]: https://www.learncpp.com/cpp-tutorial/scoped-enumerations-enum-classes/
  [4]: https://www.learncpp.com/cpp-tutorial/fixed-width-integers-and-size-t/
  [5]: javascript:void(0)
