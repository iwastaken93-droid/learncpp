title: "10.6 — Explicit type conversion (casting) and static_cast – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/explicit-type-conversion-casting-and-static-cast/
...
# 10.6 â€" Explicit type conversion (casting) and static_cast

[*Alex*][1] April 16, 2015, 3:54 pm PDT March 4, 2025

In lesson [10.1 -- Implicit type conversion][2], we discussed that the compiler can use implicit type conversion to convert a value from one data type to another. When you want to numerically promote a value from one data type to a wider data type, using implicit type conversion is fine.
...
We discuss `dynamic_cast` in lesson [25.10 -- Dynamic casting][3], after we've covered other prerequisite topics.
...
Since static_cast uses direct initialization, any explicit constructors of the target class type will be considered when initializing the temporary object to be returned. We discuss explicit constructors in lesson [14.16 -- Converting constructors and the explicit keyword][4].
...
We discuss more uses of static_cast in relation to class types in lesson [14.13 -- Temporary class objects][5].
...
10.7Typedefs and type aliases

Back to table of contents

Previous lesson

10.5Arithmetic conversions
  ...
  [4]: https://www.learncpp.com/cpp-tutorial/converting-constructors-and-the-explicit-keyword/
