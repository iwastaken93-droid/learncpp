title: "10.4 — Narrowing conversions, list initialization, and constexpr initializers – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/narrowing-conversions-list-initialization-and-constexpr-initializers/
...
# 10.4 â€" Narrowing conversions, list initialization, and constexpr initializers

[*Alex*][1] May 5, 2023, 6:10 pm PDT February 16, 2024

In the previous lesson ([10.3 -- Numeric conversions][2]), we covered numeric conversions, which cover a wide range of different type conversions between fundamental types.
