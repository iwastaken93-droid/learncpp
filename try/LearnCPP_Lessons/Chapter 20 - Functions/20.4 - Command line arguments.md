title: "20.4 — Command line arguments – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/command-line-arguments/
...
# 20.4 â€" Command line arguments

[*Alex*][1] February 15, 2008, 4:06 pm PST June 25, 2024

**The need for command line arguments**

As you learned in lesson [0.5 -- Introduction to the compiler, linker, and libraries][2], when you compile and link your program, the output is an executable file. When a program is run, execution starts at the top of the function called main(). Up to this point, we've declared main like this:
...
The C++ way to do this follows:
    ...
    int main(int argc, char* argv[])
    {
        ...
        std::stringstream convert{ argv[3] }; // set up a stringstream variable named convert, initialized with the input from argv[3]
        int myint{};
...
20.3Recursion
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/introduction-to-the-compiler-linker-and-libraries/
  [3]: https://www.learncpp.com/cpp-tutorial/ellipsis-and-why-to-avoid-them/
  [4]: https://www.learncpp.com/
  [5]: https://www.learncpp.com/cpp-tutorial/recursion/
