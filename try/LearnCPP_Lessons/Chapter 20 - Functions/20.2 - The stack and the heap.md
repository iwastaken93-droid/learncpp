title: "20.2 — The stack and the heap – Learn C++"
...
# 20.2 â€" The stack and the heap

[*Alex*][1] August 10, 2007, 4:56 pm PDT June 25, 2024
...
The heap segment (also known as the "free store�) keeps track of memory used for dynamic memory allocation. We talked about the heap a bit already in lesson [19.1 -- Dynamic memory allocation with new and delete][2], so this will be a recap.
...
We talk more about functions that call themselves in upcoming lesson [20.3 -- Recursion][3].
...
[This comment][4] has some additional (simplified) information about how variables on the stack are laid out and receive actual memory addresses at runtime.
