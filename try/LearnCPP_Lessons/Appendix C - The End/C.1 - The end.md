title: "C.1 — The end? – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/appendix-c-the-end/
...
[*Alex*][1] February 16, 2018, 3:28 pm PST July 12, 2024
...
Another option is to spend time improving your understanding of best practices. For this, I highly recommend having a read-through of [the CPP Core Guidelines][3], with an optional delving into the [GSL library][4].

Keep practicing!

The best way to get better at programming is to do more programming!

Developing a larger project (e.g. 1000+ lines of code) can be fun and challenging. Try implementing a simple game or simulation of some kind! Card games are often a good choice, as they tend to have fairly straightforward rules, and can be implemented using console output. One suggestion: [Crazy Eights][5].

Now would also be a good time to join a website that offers various programming exercises to test your skills. We highly recommend [Codewars][6], as it is free and has a ton of creative programming challenges! [Project Euler][7] also has a lot of challenging problems to solve.

Don't stop when you've got something working. Spend some time refining your code (e.g. refactoring, removing redundancy). Measure the speed of your solution (see [18.4 -- Timing your code][8]) and then see if you can find ways to optimize your code so it performs faster!
...
B.5Introduction to C++23

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://en.cppreference.com/w/cpp
  [3]: https://github.com/isocpp/CppCoreGuidelines
  [4]: https://github.com/microsoft/GSL
  [5]: https://en.wikipedia.org/wiki/Crazy_Eights
  [6]: http://www.codewars.com
  [7]: https://projecteuler.net/
  [8]: https://www.learncpp.com/cpp-tutorial/timing-your-code/
  [9]: https://www.learncpp.com/cpp-tutorial/the-standard-library/
  [10]: https://www.learncpp.com/
  [11]: https://www.learncpp.com/cpp-tutorial/introduction-to-c23/
