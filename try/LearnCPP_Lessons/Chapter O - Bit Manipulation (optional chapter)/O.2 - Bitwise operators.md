title: "O.2 — Bitwise operators – Learn C++"
...
[*Alex*][1] June 17, 2007, 1:12 pm PDT February 26, 2025
...
Bit-shifting in C++ is [endian][2]-agnostic. Left-shift is always towards the most significant bit, and right-shift towards the least significant bit.
...
This ability for operators to change their behavior based on the type of the arguments leverages a feature called *operator overloading*, which we introduce later in lesson [13.5 -- Introduction to overloading the I/O operators][3].
...
We cover integral promotion in lesson [10.2 -- Floating-point and integral promotion][4].
...
We have named the function "rotl� rather than "rotateLeft�, because "rotl� is a well-established name in computer science and also the name of the standard function, [`std::rotl`][6].
...
O.1Bit flags and bit manipulation via std::bitset
  ...
  [3]: https://www.learncpp.com/cpp-tutorial/introduction-to-overloading-the-i-o-operators/
  [4]: https://www.learncpp.com/cpp-tutorial/floating-point-and-integral-promotion/
  [5]: javascript:void(0)
  [6]: https://en.cppreference.com/w/cpp/numeric/rotl
