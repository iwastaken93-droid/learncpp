title: "O.1 — Bit flags and bit manipulation via std::bitset – Learn C++"
...
[*Alex*][1] August 17, 2019, 12:06 pm PDT February 15, 2025
...
We introduced member functions in lesson [5.7 -- Introduction to std::string][2]. With normal functions, we call `function(object)`. With member functions, we call `object.function()`.

We covered the `0b` binary literal prefix and the `'` digit separator in lesson
...
We cover `[maybe_unused]` in lesson [1.4 -- Variable assignment and initialization][3].

In lesson [13.2 -- Unscoped enumerations][4], we show how enumerators make an even better collection of named bits.
...
6.xChapter 6 summary and quiz
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/introduction-to-stdstring/
  [3]: https://www.learncpp.com/cpp-tutorial/variable-assignment-and-initialization/
  [4]: https://www.learncpp.com/cpp-tutorial/unscoped-enumerations/
  [5]: https://www.learncpp.com/cpp-tutorial/bitwise-operators/
  [6]: https://www.learncpp.com/
  [7]: https://www.learncpp.com/cpp-tutorial/chapter-6-summary-and-quiz/
