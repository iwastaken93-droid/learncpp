title: "16.5 — Returning std::vector, and an introduction to move semantics – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/returning-stdvector-and-an-introduction-to-move-semantics/
...
[*Alex*][1] January 10, 2024, 7:20 pm PST December 16, 2024
...
We covered copy elision in lesson [14.15 -- Class initialization and copy elision][2].
...
We'll dig into how move semantics works in more detail in [chapter 22][3]. For now, it's enough to know what move semantics is, and which types are move-capable.
...
16.4Passing std::vector
  ...
  [4]: https://www.learncpp.com/cpp-tutorial/arrays-and-loops/
  [5]: https://www.learncpp.com/
  [6]: https://www.learncpp.com/cpp-tutorial/passing-stdvector/
