title: "16.9 — Array indexing and length using enumerators – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/array-indexing-and-length-using-enumerators/
...
# 16.9 â€" Array indexing and length using enumerators

[*Alex*][1] September 11, 2023, 2:43 pm PDT May 8, 2024
...
Consider an array holding 5 test scores:
    ...
    int main()
    {
        ...
        testScores[6] = 76; // who does this represent?
    }

Who is the student represented by `testScores[6]`? It's not clear.
...
We discuss this further in lesson [17.3 -- Passing and returning std::array][2].
...
A better option is to use the helper function that we introduced in lesson [13.6 -- Scoped enumerations (enum classes)][3], which allows us to convert the enumerators of enum classes to integral values using unary `operator+`.
...
16.10std::vector resizing and capacity
...
16.8Range-based for loops (for-each)
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/passing-and-returning-stdarray/
  [3]: https://www.learncpp.com/cpp-tutorial/scoped-enumerations-enum-classes/#operatorplus
  [4]: javascript:void(0)
  [5]: https://www.learncpp.com/cpp-tutorial/stdvector-resizing-and-capacity/
