title: "16.8 — Range-based for loops (for-each) – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/range-based-for-loops-for-each/
...
# 16.8 â€" Range-based for loops (for-each)

[*Alex*][1] July 31, 2015, 5:25 pm PDT December 28, 2024

In lesson [16.6 -- Arrays and loops][2], we showed examples where we used a for-loop to iterate through each element of an array using a loop variable as an index. Here's another example of such:
...
Although for-loops provide a convenient and flexible way to iterate through an array, they are also easy to mess up, prone to off-by-one errors, and subject to array indexing sign problems (discussed in lesson [16.7 -- Arrays, loops, and sign challenge solutions][3]).
...
Range-based for loops also won't work with enumerations. We show a method for working around this in lesson [17.6 -- std::array and enumerations][4].
...
16.9Array indexing and length using enumerators
...
16.7Arrays, loops, and sign challenge solutions
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/arrays-and-loops/
  [3]: https://www.learncpp.com/cpp-tutorial/arrays-loops-and-sign-challenge-solutions/
  [4]: https://www.learncpp.com/cpp-tutorial/stdarray-and-enumerations/
  [5]: javascript:void(0)
  [6]: https://www.learncpp.com/cpp-tutorial/array-indexing-and-length-using-enumerators/
