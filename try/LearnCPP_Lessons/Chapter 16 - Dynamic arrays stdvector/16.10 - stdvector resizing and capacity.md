title: "16.10 — std::vector resizing and capacity – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/stdvector-resizing-and-capacity/
...
# 16.10 â€" std::vector resizing and capacity

[*Alex*][1] November 24, 2015, 4:15 pm PST January 10, 2024
...
The process of acquiring new memory at runtime is called dynamic memory allocation. We cover this in lesson [19.1 -- Dynamic memory allocation with new and delete][2].
...
16.9Array indexing and length using enumerators
  ...
  [3]: javascript:void(0)
  [4]: https://www.learncpp.com/cpp-tutorial/stdvector-and-stack-behavior/
