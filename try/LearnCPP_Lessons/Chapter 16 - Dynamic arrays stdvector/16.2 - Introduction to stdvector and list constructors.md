title: "16.2 — Introduction to std::vector and list constructors – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/introduction-to-stdvector-and-list-constructors/
...
# 16.2 â€" Introduction to std::vector and list constructors

[*Alex*][1] September 28, 2015, 4:34 pm PDT December 26, 2024

In the previous lesson [16.1 -- Introduction to containers and arrays][2], we introduced both containers and arrays. In this lesson, we'll introduce the array type that we'll be focused on for the rest of the chapter: `std::vector`. We'll also solve one part of the scalability challenge we introduced last lesson.
...
A vector with no elements may not seem useful now, but we'll encounter this again in future lessons (particularly [16.11 -- std::vector and stack behavior][3]).
...
In lesson [13.8 -- Struct aggregate initialization][4], we defined an initializer list as a braced list of comma-separated values (e.g. `{ 1, 2, 3 }`).
...
We discuss adding list constructors to your own program-defined classes in lesson [23.7 -- std::initializer_list][5].
...
We discuss how indexes are relative distances (not absolute positions) in lesson [17.9 -- Pointer arithmetic and subscripting][6]
...
Here's an example:
    ...
    int main()
    {
        ...
        std::cout << "The second prime number is: " << primes[10] << '\n';
        std::cout << "The sum of the first 5 primes is: " << primes[0] + primes[10] + primes[2] + primes[3] + primes[4] << '\n';
        return 0;
    }
...
We'll talk more about `operator[]` and some other methods for accessing array elements in the next lesson
...
We'll talk about the math behind subscripting in lesson [17.9 -- Pointer arithmetic and subscripting][6].
...
Per [Howard Hinnant's comment here][7], the standard library containers were not designed to have const elements.
...
We cover `std::array` in lesson [17.1 -- Introduction to std::array][8].
...
[Show Solution][9]
    ...
    int main()
    {
        ...
        std::cin >> arr[0] >> arr[10] >> arr[2];
        std::cout << "The sum is: " << arr[0] + arr[10] + arr[2] << '\n';
        std::cout << "The product is: " << arr[0] * arr[10] * arr[2] << '\n';
        return 0;
    }

Next lesson

16.3std::vector and the unsigned length and subscript problem

Back to table of contents

Previous lesson

16.1Introduction to containers and arrays

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/introduction-to-containers-and-arrays/
  [3]: https://www.learncpp.com/cpp-tutorial/stdvector-and-stack-behavior/
  [4]: https://www.learncpp.com/cpp-tutorial/struct-aggregate-initialization/
  [5]: https://www.learncpp.com/cpp-tutorial/stdinitializer_list/
  [6]: https://www.learncpp.com/cpp-tutorial/pointer-arithmetic-and-subscripting/
  [7]: https://stackoverflow.com/questions/6954906/does-c11-allow-vectorconst-t#comment8294604_6955332
  [8]: https://www.learncpp.com/cpp-tutorial/introduction-to-stdarray/
  [9]: javascript:void(0)
