title: "27.3 — Exceptions, functions, and stack unwinding – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/exceptions-functions-and-stack-unwinding/
...
# 27.3 â€" Exceptions, functions, and stack unwinding

[*Alex*][1] October 5, 2008, 11:25 am PDT September 29, 2024

In the previous lesson on [27.2 -- Basic exception handling][2], we explained how throw, try, and catch work together to enable exception handling. In this lesson, we'll talk about how exception handling interacts with functions.
...
Before proceeding, see lesson [20.2 -- The stack and the heap][3] if you need a refresher on call stacks and stack unwinding.
...
If no matching exception handler is found, the stack may or may not be unwound. We will talk more about this case in the next lesson ([27.4 -- Uncaught exceptions and catch-all handlers][4]).
...
27.2Basic exception handling

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/basic-exception-handling/
  [3]: https://www.learncpp.com/cpp-tutorial/the-stack-and-the-heap/
  [4]: https://www.learncpp.com/cpp-tutorial/uncaught-exceptions-catch-all-handlers/
