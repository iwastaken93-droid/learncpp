title: "27.9 — Exception specifications and noexcept – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/exception-specifications-and-noexcept/
...
# 27.9 â€" Exception specifications and noexcept

[*Alex*][1] August 11, 2020, 9:16 pm PDT October 31, 2024
...
- move constructors and move assignment (move semantics, covered in [chapter 22][3])
- swap functions
- clear/erase/reset functions on containers
- operations on std::unique_ptr (also covered in [chapter 22][3])
...
Due to factors such as incomplete compiler implementations, some incompatibility with template functions, common misunderstandings about how they worked, and the fact that the standard library mostly didn't use them, the dynamic exception specifications were deprecated in C++11 and removed from the language in C++17 and C++20. See [this paper][5] for more context.

Next lesson

27.10std::move_if_noexcept

Back to table of contents

Previous lesson

27.8Exception dangers and downsides

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/exception-dangers-and-downsides/
  [3]: https://www.learncpp.com#Chapter22
  [4]: https://www.learncpp.com/cpp-tutorial/stdmove_if_noexcept/
  [5]: http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2015/p0003r0.html#2.0
