title: "27.10 — std::move_if_noexcept – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/stdmove_if_noexcept/
...
# 27.10 â€" std::move_if_noexcept

[*Alex*][1] August 16, 2020, 3:28 pm PDT August 15, 2024

(h/t to reader Koe for providing the first draft of this lesson!)

In lesson [22.4 -- std::move][2], we covered `std::move`, which casts its lvalue argument to an rvalue so that we can invoke move semantics. And in lesson [27.9 -- Exception specifications and noexcept][3], we covered the `noexcept` exception specifier and operator. This lesson builds on both concepts.
...
27.xChapter 27 summary and quiz

Back to table of contents

Previous lesson

27.9Exception specifications and noexcept

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/stdmove/
  [3]: https://www.learncpp.com/cpp-tutorial/exception-specifications-and-noexcept/
  [4]: https://www.learncpp.com/cpp-tutorial/chapter-27-summary-and-quiz/
