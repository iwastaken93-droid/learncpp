title: "27.1 — The need for exceptions – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/the-need-for-exceptions/
...
# 27.1 â€" The need for exceptions

[*Alex*][1] October 4, 2008, 1:26 pm PDT May 23, 2024

In the previous lesson on [handling errors][2], we talked about ways to use assert(), std::cerr, and exit() to handle errors. However, we deferred one further topic that we will now cover: exceptions.
...
26.xChapter 26 summary and quiz
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/712-handling-errors-assert-cerr-exit-and-exceptions/
  [3]: https://www.learncpp.com/cpp-tutorial/basic-exception-handling/
