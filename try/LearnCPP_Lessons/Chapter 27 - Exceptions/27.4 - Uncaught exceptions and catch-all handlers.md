title: "27.4 — Uncaught exceptions and catch-all handlers – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/uncaught-exceptions-catch-all-handlers/
...
# 27.4 â€" Uncaught exceptions and catch-all handlers

[*Alex*][1] October 25, 2008, 12:07 pm PDT September 12, 2024
...
If you recall from lesson [20.5 -- Ellipsis (and why to avoid them)][2], ellipses were previously used to pass arguments of any type to a function. In this context, they represent exceptions of any data type. Here's an simple example:
...
27.5Exceptions, classes, and inheritance
...
27.3Exceptions, functions, and stack unwinding
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/ellipsis-and-why-to-avoid-them/
  [3]: https://www.learncpp.com/cpp-tutorial/exceptions-classes-and-inheritance/
