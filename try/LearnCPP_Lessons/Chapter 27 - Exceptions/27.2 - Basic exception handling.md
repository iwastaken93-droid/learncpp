title: "27.2 — Basic exception handling – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/basic-exception-handling/
...
# 27.2 â€" Basic exception handling

[*Alex*][1] October 4, 2008, 1:29 pm PDT January 6, 2025

In the previous lesson on [the need for exceptions][2], we talked about how using return codes causes your control flow and error flow to be intermingled, constraining both. Exceptions in C++ are implemented using three keywords that work in conjunction with each other: **throw**, **try**, and **catch**.
...
27.3Exceptions, functions, and stack unwinding

Back to table of contents

Previous lesson

27.1The need for exceptions

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/151-the-need-for-exceptions/
  [3]: https://www.learncpp.com/cpp-tutorial/exceptions-functions-and-stack-unwinding/
  [4]: https://www.learncpp.com/
  [5]: https://www.learncpp.com/cpp-tutorial/the-need-for-exceptions/
