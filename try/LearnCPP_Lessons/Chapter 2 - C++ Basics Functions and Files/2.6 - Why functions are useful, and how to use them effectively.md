title: "2.6 — Why functions are useful, and how to use them effectively – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/why-functions-are-useful-and-how-to-use-them-effectively/
...
# 2.6 â€" Why functions are useful, and how to use them effectively

[*Alex*][1] August 4, 2015, 4:38 pm PDT January 25, 2023
...
- <u>Extensibility</u> -- When we need to extend our program to handle a case it didn't handle before, functions allow us to make the change in one place and have that change take effect every time the function is called.
...
2.5Introduction to local scope
...
*Previous Post*[16.8 â€" Range-based for loops (for-each)][6]

  [6]: https://www.learncpp.com/cpp-tutorial/range-based-for-loops-for-each/

*Next Post*[12.8 â€" Null pointers][7]

  [7]: https://www.learncpp.com/cpp-tutorial/null-pointers/
