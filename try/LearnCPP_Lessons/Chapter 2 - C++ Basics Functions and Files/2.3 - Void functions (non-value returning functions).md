title: "2.3 — Void functions (non-value returning functions) – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/void-functions-non-value-returning-functions/
...
# 2.3 â€" Void functions (non-value returning functions)

[*Alex*][1] April 15, 2022, 5:19 pm PDT October 23, 2023

In a prior lesson ([2.1 -- Introduction to functions][2]), we indicated that the syntax for a function definition looks like this:
