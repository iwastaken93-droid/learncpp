title: "2.10 — Introduction to the preprocessor – Learn C++"
...
# 2.10 â€" Introduction to the preprocessor

[*Alex*][1] June 3, 2007, 12:57 pm PDT March 5, 2025
...
If you're curious, here is a list of [translation phases][2]. As of the time of writing, preprocessing encompasses phases 1 through 4, and compilation is phases 5 through 7.
...
`Using directives` (introduced in lesson [2.9 -- Naming collisions and an introduction to namespaces][3]) are not preprocessor directives (and thus are not processed by the preprocessor). So while the term `directive` *usually* means a `preprocessor directive`, this is not always the case.
...
You can see a practical use of this feature in lesson [0.13 -- What language standard is my compiler using?][4].
...
2.9Naming collisions and an introduction to namespaces
  ...
  [4]: https://www.learncpp.com/cpp-tutorial/what-language-standard-is-my-compiler-using/
  [5]: https://www.learncpp.com/cpp-tutorial/header-files/
