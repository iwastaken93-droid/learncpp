title: "2.8 — Programs with multiple code files – Learn C++"
...
# 2.8 â€" Programs with multiple code files

[*Alex*][1] June 2, 2007, 8:26 pm PDT February 11, 2025
...
In lesson [2.7 -- Forward declarations and definitions][9], we took a look at a single-file program that wouldn't compile:
...
We'll explore what happens when names do conflict in the next lesson ([2.9 -- Naming collisions and an introduction to namespaces][10]).
...
1.  Do *not* *\#include "add.cpp�* from *main.cpp*. While doing so compiles in this case, \#including .cpp files increases the risk of naming conflicts and other unanticipated consequences (especially as programs get larger and more complex). We discuss \#include further in lesson [2.10 -- Introduction to the preprocessor][11].
...
2.7Forward declarations and definitions
  ...
  [2]: https://www.learncpp.com/images/CppTutorial/Chapter2/VS-AddNewItem1.png
  [3]: https://www.learncpp.com/images/CppTutorial/Chapter2/VS-AddNewItem2.png
  [4]: https://www.learncpp.com/images/CppTutorial/Chapter2/CB-AddNewItem1.png
  [5]: https://www.learncpp.com/images/CppTutorial/Chapter2/CB-AddNewItem2.png
  [6]: https://www.learncpp.com/images/CppTutorial/Chapter2/CB-AddNewItem3.png
  [7]: https://www.learncpp.com/images/CppTutorial/Chapter2/CB-AddNewItem4.png
  [8]: https://www.learncpp.com/images/CppTutorial/Chapter2/CB-AddNewItem5.png
  [9]: https://www.learncpp.com/cpp-tutorial/forward-declarations/
  [10]: https://www.learncpp.com/cpp-tutorial/naming-collisions-and-an-introduction-to-namespaces/
