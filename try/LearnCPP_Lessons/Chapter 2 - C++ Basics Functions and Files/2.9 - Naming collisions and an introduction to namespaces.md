title: "2.9 — Naming collisions and an introduction to namespaces – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/naming-collisions-and-an-introduction-to-namespaces/
...
# 2.9 â€" Naming collisions and an introduction to namespaces

[*Alex*][1] November 6, 2016, 10:42 pm PST February 18, 2025
...
We discuss the global namespace in more detail in lesson [7.4 -- Introduction to global variables][2].
...
We talk more about using-declarations and using-directives (and how to use them responsibly) in lesson [7.13 -- Using declarations and using directives][4].
