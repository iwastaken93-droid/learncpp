title: "2.2 — Function return values (value-returning functions) – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/function-return-values-value-returning-functions/
...
[*Alex*][1] February 1, 2019, 10:29 am PST February 5, 2025
...
We explore functions that return `void` further in the next lesson ([2.3 -- Void functions (non-value returning functions)][2]).
...
Global variables are initialized prior to the execution of `main`. If the initializer for such a variable invokes a function, then that function will execute prior to `main`. We discuss global variables in lesson [7.4 -- Introduction to global variables][3].
...
We cover the preprocessor and preprocessor macros in lesson [2.10 -- Introduction to the preprocessor][4].
...
We discuss undefined behavior in lesson [1.6 -- Uninitialized variables and undefined behavior][5].
...
Like all best practices, DRY is meant to be a guideline, not an absolute. Reader Yariv has [noted][6] that DRY can harm overall comprehension when code is broken into pieces that are too small.
...
This program will not compile because the function has an invalid name. We talked about naming rules in lesson [1.7 -- Keywords and naming identifiers][8].
...
2.3Void functions (non-value returning functions)
...
2.1Introduction to functions
  ...
  [3]: https://www.learncpp.com/cpp-tutorial/introduction-to-global-variables/
  [4]: https://www.learncpp.com/cpp-tutorial/introduction-to-the-preprocessor/
  [5]: https://www.learncpp.com/cpp-tutorial/uninitialized-variables-and-undefined-behavior/
  [6]: https://www.learncpp.com/cpp-tutorial/function-return-values-value-returning-functions/#comment-593257
  [7]: javascript:void(0)
  [8]: https://www.learncpp.com/cpp-tutorial/keywords-and-naming-identifiers/#rules
  [9]: https://www.learncpp.com/
  [10]: https://www.learncpp.com/cpp-tutorial/introduction-to-functions/
