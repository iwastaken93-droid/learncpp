title: "2.12 — Header guards – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/header-guards/
...
[*Alex*][1] April 5, 2016, 11:41 am PDT June 12, 2024

The duplicate definition problem

In lesson [2.7 -- Forward declarations and definitions][2], we noted that a variable or function identifier can only have one definition (the one definition rule). Thus, a program that defines a variable identifier more than once will cause a compile error:
