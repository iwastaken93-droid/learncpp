title: "2.5 — Introduction to local scope – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/introduction-to-local-scope/
...
# 2.5 â€" Introduction to local scope

[*Alex*][1] February 8, 2015, 5:06 pm PST January 1, 2025
...
If the object is a class type object, prior to destruction, a special function called a destructor is invoked. In many cases, the destructor does nothing, in which case no cost is incurred. We introduce destructors in lesson [15.4 -- Introduction to destructors][3].
...
2.4Introduction to function parameters and arguments
