title: "2.1 — Introduction to functions – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/introduction-to-functions/
...
[*Alex*][1] May 31, 2007, 5:23 pm PDT September 28, 2024
...
For now, a function must be defined before it can be called. We'll discuss ways to work around this in lesson [2.7 -- Forward declarations and definitions][3].
...
2.2Function return values (value-returning functions)
...
1.xChapter 1 summary and quiz
  ...
  [4]: https://en.wikipedia.org/wiki/Metasyntactic_variable
  [5]: https://datatracker.ietf.org/doc/html/rfc3092
  [6]: javascript:void(0)
  [7]: https://www.learncpp.com/
  [8]: https://www.learncpp.com/cpp-tutorial/chapter-1-summary-and-quiz/
