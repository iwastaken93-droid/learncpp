title: "2.4 — Introduction to function parameters and arguments – Learn C++"
...
# 2.4 â€" Introduction to function parameters and arguments

[*Alex*][1] January 25, 2015, 12:12 pm PST February 18, 2025
...
1.  Operators `++` and `--` have prefix and postfix variants (e.g. `++foo` vs `foo++`). An unreferenced function parameter is used to differentiate whether an overload of such an operator is for the prefix or postfix case. We cover this in lesson [21.8 -- Overloading the increment and decrement operators][3].
...
2.3Void functions (non-value returning functions)
  ...
  [2]: https://www.learncpp.com/images/CppTutorial/Chapter2/ParametersReturn.png
  [3]: https://www.learncpp.com/cpp-tutorial/overloading-the-increment-and-decrement-operators/
  [4]: javascript:void(0)
