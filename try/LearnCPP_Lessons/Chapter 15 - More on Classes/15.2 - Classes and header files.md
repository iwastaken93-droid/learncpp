title: "15.2 — Classes and header files – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/classes-and-header-files/
...
[*Alex*][1] September 11, 2007, 8:50 am PDT January 3, 2025
...
Finally, for template classes, template member functions defined outside the class are almost always defined inside the header file, beneath the class definition. Just like non-member template functions, the compiler needs to see the full template definition in order to instantiate it. We cover template member functions in lesson [15.5 -- Class templates with member functions][3].
...
In lesson [11.5 -- Default arguments][4], we discussed the best practice for default arguments of non-member functions: "If the function has a forward declaration (especially one in a header file), put the default argument there. Otherwise, put the default argument in the function definition.�
...
15.1The hidden "this� pointer and member function chaining

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/header-files/
  [3]: https://www.learncpp.com/cpp-tutorial/class-templates-with-member-functions/
  [4]: https://www.learncpp.com/cpp-tutorial/default-arguments/
  [5]: javascript:void(0)
