title: "15.x — Chapter 15 summary and quiz – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/chapter-15-summary-and-quiz/
...
# 15.x â€" Chapter 15 summary and quiz

[*Alex*][1] September 11, 2023, 1:08 pm PDT May 3, 2024
...
h\) Now we'll randomize our generated monster. Grab the "Random.h� code from [8.15 -- Global random numbers (Random.h)][3] and save it as Random.h. Then use `Random::get()` to generate a random monster type, random name, random roar, and random hit points (between 1 and 100).
