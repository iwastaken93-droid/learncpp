title: "15.6 — Static member variables – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/static-member-variables/
...
# 15.6 â€" Static member variables

[*Alex*][1] September 14, 2007, 9:50 am PDT December 2, 2024

In the lesson [7.4 -- Introduction to global variables][2], we introduced global variables, and in lesson [7.11 -- Static local variables][3], we introduced static local variables. Both of these types of variables have static duration, meaning they are created at the start of the program, and destroyed at the end of the program. Such variables keep their values even if they go out of scope.
...
15.5Class templates with member functions
  ...
  [4]: https://www.learncpp.com/cpp-tutorial/static-member-functions/
  [5]: https://www.learncpp.com/
  [6]: https://www.learncpp.com/cpp-tutorial/class-templates-with-member-functions/
