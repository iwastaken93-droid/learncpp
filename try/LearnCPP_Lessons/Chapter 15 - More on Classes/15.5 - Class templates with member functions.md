title: "15.5 — Class templates with member functions – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/class-templates-with-member-functions/
...
# 15.5 â€" Class templates with member functions

[*Alex*][1] September 11, 2023, 12:59 pm PDT August 6, 2024

In lesson [11.6 -- Function templates][2], we took a look at function templates:
...
In lesson [13.13 -- Class templates][3], we covered class templates, which allow us to use type template parameters for the type of our data members of class types (struct, classes, and unions):
...
15.4Introduction to destructors
  ...
  [4]: https://www.learncpp.com/cpp-tutorial/function-template-instantiation/
  [5]: javascript:void(0)
  [6]: https://www.learncpp.com/cpp-tutorial/static-member-variables/
