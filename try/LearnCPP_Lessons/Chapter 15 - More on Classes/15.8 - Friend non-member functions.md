title: "15.8 — Friend non-member functions – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/friend-non-member-functions/
...
# 15.8 â€" Friend non-member functions

[*Alex*][1] September 20, 2007, 2:04 pm PDT May 8, 2024

For much of this chapter and last, we've been preaching the virtues of access controls, which provide a mechanism for controlling who can access the various members of a class. Private members can only be accessed by other members of the class and public members can be accessed by everyone. In lesson [14.6 -- Access functions][2], we discussed the benefits of keeping your data private, and creating a public interface for non-members to use.
...
In lesson [14.8 -- The benefits of data hiding (encapsulation)][4], we mentioned that we should prefer non-member functions over member functions. For the same reasons given there, we should prefer non-friend functions over friend functions.
