title: "15.7 — Static member functions – Learn C++"
...
# 15.7 â€" Static member functions

[*Alex*][1] September 18, 2007, 9:08 am PDT October 18, 2024

In the previous lesson on [15.6 -- Static member variables][2], you learned that static member variables are member variables that belong to the class rather than objects of the class. If a static member variable is public, it can be accessed directly using the class name and the scope resolution operator:
...
We show a practical example of this methodology in lesson [8.15 -- Global random numbers (Random.h)][4] (though we do it with a namespace rather than a static class, it works the same way)
