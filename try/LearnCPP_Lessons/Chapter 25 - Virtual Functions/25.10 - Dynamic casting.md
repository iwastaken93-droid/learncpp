title: "25.10 — Dynamic casting – Learn C++"
...
# 25.10 â€" Dynamic casting

[*Alex*][1] November 22, 2016, 4:48 pm PST December 29, 2024

Way back in lesson [10.6 -- Explicit type conversion (casting) and static_cast][2], we examined the concept of casting, and the use of static_cast to convert variables from one type to another.
...
3.  In certain cases involving virtual base classes (see [this page][3] for an example of some of these cases, and how to resolve them).
...
25.11Printing inherited classes using operator\<\<
