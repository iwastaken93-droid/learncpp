title: "25.7 — Pure virtual functions, abstract base classes, and interface classes – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/pure-virtual-functions-abstract-base-classes-and-interface-classes/
...
# 25.7 â€" Pure virtual functions, abstract base classes, and interface classes

[*Alex*][1] February 13, 2008, 4:09 pm PST October 1, 2024
...
The virtual table entry for a class with a pure virtual function will generally either contain a null pointer, or point to a generic function that prints an error (sometimes this function is named \_\_purecall).

Next lesson

25.8Virtual base classes

Back to table of contents

Previous lesson

25.6The virtual table
