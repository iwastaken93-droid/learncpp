title: "25.2 — Virtual functions and polymorphism – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/virtual-functions/
...
# 25.2 â€" Virtual functions and polymorphism

[*Alex*][1] January 30, 2008, 3:46 pm PST December 11, 2024

In the previous lesson on [pointers and references to the base class of derived objects][2], we took a look at a number of examples where using pointers or references to a base class had the potential to simplify code. However, in every case, we ran up against the problem that the base pointer or reference was only able to call the base version of a function, not a derived version.
...
25.3The override and final specifiers, and covariant return types

Back to table of contents

Previous lesson

25.1Pointers and references to the base class of derived objects

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/121-pointers-and-references-to-the-base-class-of-derived-objects/
  [3]: javascript:void(0)
