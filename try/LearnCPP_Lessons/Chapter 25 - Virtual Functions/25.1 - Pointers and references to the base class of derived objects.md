title: "25.1 — Pointers and references to the base class of derived objects – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/pointers-and-references-to-the-base-class-of-derived-objects/
...
# 25.1 â€" Pointers and references to the base class of derived objects

[*Alex*][1] January 29, 2008, 3:45 pm PST November 25, 2024
...
In the chapter on [construction of derived classes][2], you learned that when you create a derived class, it is composed of multiple parts: one part for each inherited class, and a part for itself.
...
1.  Why is the above solution non-optimal?
...
25.2Virtual functions and polymorphism
