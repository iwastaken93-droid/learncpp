title: "4.10 — Introduction to if statements – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/introduction-to-if-statements/
...
[*Alex*][1] April 23, 2019, 12:57 pm PDT February 11, 2025
...
*If statements* only conditionally execute a single statement. We talk about how to conditionally execute multiple statements in lesson [8.2 -- If statements and blocks][2].
...
In the previous lesson ([4.9 -- Boolean values][3]), we wrote this program using a function that returns a Boolean value:
...
We discuss the debate over early returns further in lesson [8.11 -- Break and continue][4]

We'll continue our exploration of if-statements in future lesson [8.2 -- If statements and blocks][2].
...
Using the logical OR (\|\|) operator ([6.8 -- Logical operators][6]):
...
Using a switch statement ([8.5 -- Switch statement basics][7]):
...
4.9Boolean values
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/if-statements-and-blocks/
  [3]: https://www.learncpp.com/cpp-tutorial/boolean-values/
  [4]: https://www.learncpp.com/cpp-tutorial/break-and-continue/
  [5]: javascript:void(0)
  [6]: https://www.learncpp.com/cpp-tutorial/logical-operators/
  [7]: https://www.learncpp.com/cpp-tutorial/switch-statement-basics/
  [8]: https://www.learncpp.com/cpp-tutorial/chars/
