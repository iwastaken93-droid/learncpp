title: "4.x — Chapter 4 summary and quiz – Learn C++"
...
[*Alex*][1] June 11, 2007, 5:42 pm PDT November 29, 2024
...
See [4.3 -- Object sizes and the sizeof operator][2] for a table indicating the minimum size for each fundamental type.
...
Hint: Consider using an early return (covered in lesson [4.10 -- Introduction to if statements][4]) if the user doesn't pass in a supported operation.
...
4.12Introduction to type conversion and static_cast
  ...
  [3]: javascript:void(0)
  [4]: https://www.learncpp.com/cpp-tutorial/introduction-to-if-statements/
  [5]: https://www.learncpp.com/cpp-tutorial/constant-variables-named-constants/
