title: "4.1 — Introduction to fundamental data types – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/introduction-to-fundamental-data-types/
...
# 4.1 â€" Introduction to fundamental data types

[*Alex*][1] June 4, 2007, 9:41 pm PDT February 26, 2025

Bits, bytes, and memory addressing

In lesson [1.3 -- Introduction to objects and variables][2], we talked about the fact that variables are names for a piece of memory that can be used to store information. To recap briefly, computers have random access memory (RAM) that is available for programs to use. When a variable is defined, a piece of that memory is set aside for that variable.
...
- The "compound data types� provide more complex data types and allow for the creation of custom (user-defined) types. We cover these in lesson [12.1 -- Introduction to compound data types][4].
...
3.xChapter 3 summary and quiz
  ...
  [3]: https://www.learncpp.com/images/CppTutorial/Section2/MemoryAddresses.png
  [4]: https://www.learncpp.com/cpp-tutorial/introduction-to-compound-data-types/
  [5]: https://www.learncpp.com/cpp-tutorial/introduction-to-stdstring/
  [6]: https://www.learncpp.com/cpp-tutorial/void/
  [7]: https://www.learncpp.com/
  [8]: https://www.learncpp.com/cpp-tutorial/chapter-3-summary-and-quiz/
