title: "4.4 — Signed integers – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/signed-integers/
...
[*Alex*][1] June 9, 2007, 11:47 am PDT December 28, 2024
...
C++ only guarantees that integers will have a certain minimum size, not that they will have a specific size. See lesson [4.3 -- Object sizes and the sizeof operator][2] for information on how to determine how large each type is on your machine.
...
The above ranges assume "two's complement� binary representation. This representation is the de-facto standard for modern architectures (as it is easier to implement in hardware), and is now required by the C++20 standard. We discuss two's complement in lesson
...
We cover what happens when unsigned integers overflow in lesson [4.5 -- Unsigned integers, and why to avoid them][3].
...
If fractional results are desired, we show a method to do this in lesson [6.2 -- Arithmetic operators][4].
...
4.3Object sizes and the sizeof operator
  ...
  [3]: https://www.learncpp.com/cpp-tutorial/unsigned-integers-and-why-to-avoid-them/
  [4]: https://www.learncpp.com/cpp-tutorial/arithmetic-operators/
  [5]: javascript:void(0)
