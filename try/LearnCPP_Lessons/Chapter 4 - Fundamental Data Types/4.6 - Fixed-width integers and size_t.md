title: "4.6 — Fixed-width integers and size_t – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/fixed-width-integers-and-size-t/
...
[*Alex*][1] November 25, 2011, 9:59 pm PST January 21, 2025
...
We discuss what this example actually prints (and how to ensure it always prints `65`) in lesson [4.12 -- Introduction to type conversion and static_cast][2], after we cover chars (and how they print) in lesson [4.11 -- Chars][3].
...
`std::size_t` is actually a typedef. We cover typedefs in lesson [10.7 -- Typedefs and type aliases][4].
...
The [C++20 standard][5] (\[basic.compound\] 1.8.2) says: "Constructing a type such that the number of bytes in its object representation exceeds the maximum value representable in the type std::size_t (17.2) is ill-formed.�
...
Some compilers limit the largest creatable object to half the maximum value of `std::size_t` (an explanation for this can be found [here][6]).
...
4.5Unsigned integers, and why to avoid them
  ...
  [5]: https://isocpp.org/files/papers/N4860.pdf#subsection.6.8.2
  [6]: https://stackoverflow.com/a/42428240
  [7]: https://www.learncpp.com/cpp-tutorial/introduction-to-scientific-notation/
  [8]: https://www.learncpp.com/
  [9]: https://www.learncpp.com/cpp-tutorial/unsigned-integers-and-why-to-avoid-them/
