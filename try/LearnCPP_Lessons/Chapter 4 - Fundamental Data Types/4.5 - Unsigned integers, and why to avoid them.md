title: "4.5 — Unsigned integers, and why to avoid them – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/unsigned-integers-and-why-to-avoid-them/
...
[*Alex*][1] April 23, 2019, 12:04 pm PDT August 29, 2024

Unsigned integers

In the previous lesson ([4.4 -- Signed integers][2]), we covered signed integers, which are a set of types that can hold positive and negative whole numbers, including 0.
...
We cover the conversion rules that require both operands of certain binary operations to be the same type in lesson [10.5 -- Arithmetic conversions][4].  
We cover if-statements in upcoming lesson [4.10 -- Introduction to if statements][5].
...
1.  [Interactive C++ panel][6] (see 9:48-13:08, 41:06-45:26, and 1:02:50-1:03:15)
2.  [Subscripts and sizes should be signed][7] (from Bjarne Stroustrup, the creator of C++)
3.  [Unsigned integers from the libtorrent blog][8]
...
4.4Signed integers
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/signed-integers/
  [3]: https://en.wikipedia.org/wiki/Integer_overflow#Definition_variations_and_ambiguity
  [4]: https://www.learncpp.com/cpp-tutorial/arithmetic-conversions/
  [5]: https://www.learncpp.com/cpp-tutorial/introduction-to-if-statements/
  [6]: https://www.youtube.com/watch?v=_nrly6PH6NU
  [7]: http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2019/p1428r0.pdf
  [8]: https://blog.libtorrent.org/2016/05/unsigned-integers/
  [9]: https://www.learncpp.com/cpp-tutorial/fixed-width-integers-and-size-t/
