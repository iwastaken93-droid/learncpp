title: "4.11 — Chars – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/chars/
...
[*Alex*][1] June 9, 2007, 7:07 pm PDT March 19, 2025
...
If you want to read in more than one char at a time (e.g. to read in a name, word, or sentence), you'll want to use a string instead of a char. A string is a collection of sequential characters (and thus, a string can hold multiple symbols). We discuss this in upcoming lesson ([5.7 -- Introduction to std::string][2]).
...
We cover this topic in lesson [1.5 -- Introduction to iostream: cout, cin, and endl][3].
...
Text between double quotes (e.g. "Hello, world!�) is treated as a C-style string literal, which can contain multiple characters. We discuss strings in lesson [5.2 -- Literals][4].

Best practice

Single characters should usually be single-quoted, not double-quoted (e.g. `'t'` or `'\n'`, not `"t"` or `"\n"`). One possible exception occurs when doing output, where it can be preferential to double quote everything for consistency (see lesson [1.5 -- Introduction to iostream: cout, cin, and endl][3]).
...
4.12Introduction to type conversion and static_cast
...
4.10Introduction to if statements
  ...
  [3]: https://www.learncpp.com/cpp-tutorial/introduction-to-iostream-cout-cin-and-endl/
  [4]: https://www.learncpp.com/cpp-tutorial/literals/
  [5]: https://www.learncpp.com/
  [6]: https://www.learncpp.com/cpp-tutorial/introduction-to-if-statements/
