title: "9.4 — Detecting and handling errors – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/detecting-and-handling-errors/
date: 2026-04-01 03:21
tags: 
description: 
...
# 9.4 â€" Detecting and handling errors

[*Alex*][1] October 22, 2007, 2:45 pm PDT January 17, 2025

In lesson [9.3 -- Common semantic errors in C++][2], we covered many types of common C++ semantic errors that new C++ programmers run into with the language. If an error is the result of a misused language feature or logic error, the error can simply be corrected.
...
In such a case, returning a `std::optional` (or `std::expected`) would be a better choice. We cover `std::optional` in lesson [12.15 -- std::optional][5].
...
We cover exception handling in [chapter 27][6] of this tutorial series.

When to use `std::cout` vs `std::cerr` vs logging

In lesson [3.4 -- Basic debugging tactics][7], we introduced `std::cerr`. You may be wondering when (or whether) you should be using `std::cerr` vs `std::cout` vs logging to a text file.
...
9.5std::cin and handling invalid input

Back to table of contents

Previous lesson

9.3Common semantic errors in C++

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/common-semantic-errors-in-c/
  [3]: https://www.learncpp.com/cpp-tutorial/finding-issues-before-they-become-problems/
  [4]: https://www.learncpp.com/cpp-tutorial/stdcin-and-handling-invalid-input/
  [5]: https://www.learncpp.com/cpp-tutorial/stdoptional/
  [6]: https://www.learncpp.com#Chapter27
  [7]: https://www.learncpp.com/cpp-tutorial/basic-debugging-tactics/
