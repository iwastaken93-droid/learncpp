title: "9.5 — std::cin and handling invalid input – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/stdcin-and-handling-invalid-input/
...
# 9.5 â€" std::cin and handling invalid input

[*Alex*][1] April 21, 2016, 1:01 pm PDT January 29, 2025
...
Before we discuss how `std::cin` and `operator>>` can fail, let's recap how they work. We discussed this material in lesson [1.5 -- Introduction to iostream: cout, cin, and endl][2].
...
9.4Detecting and handling errors
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/introduction-to-iostream-cout-cin-and-endl/#extraction
  [3]: https://www.learncpp.com/cpp-tutorial/assert-and-static_assert/
  [4]: https://www.learncpp.com/
  [5]: https://www.learncpp.com/cpp-tutorial/detecting-and-handling-errors/
