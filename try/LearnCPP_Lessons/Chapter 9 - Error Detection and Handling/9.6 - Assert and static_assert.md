title: "9.6 — Assert and static_assert – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/assert-and-static_assert/
...
# 9.6 â€" Assert and static_assert

[*Alex*][1] May 14, 2017, 2:57 pm PDT November 2, 2024

In a function that takes parameters, the caller may be able to pass in arguments that are syntactically valid but semantically meaningless. For example, in the previous lesson ([9.4 -- Detecting and handling errors][2]), we showed the following sample function:
...
We talk about a common type of invariant called a "class invariant� in lesson [14.2 -- Introduction to classes][3].
...
9.5std::cin and handling invalid input
  ...
  [4]: https://www.learncpp.com/cpp-tutorial/chapter-9-summary-and-quiz/
