title: "13.6 — Scoped enumerations (enum classes) – Learn C++"
...
# 13.6 â€" Scoped enumerations (enum classes)

[*Alex*][1] April 23, 2015, 4:22 pm PDT February 11, 2025
...
Scoped enumerations work similarly to unscoped enumerations ([13.2 -- Unscoped enumerations][2]), but have two primary differences: They won't implicitly convert to integers, and the enumerators are *only* placed into the scope region of the enumeration (not into the scope region where the enumeration is defined).
