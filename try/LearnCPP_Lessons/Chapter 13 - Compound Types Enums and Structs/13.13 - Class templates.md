title: "13.13 — Class templates – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/class-templates/
...
# 13.13 â€" Class templates

[*Alex*][1] April 21, 2022, 1:48 pm PDT December 30, 2024

In lesson [11.6 -- Function templates][2], we introduced the challenge of having to create a separate (overloaded) function for each different set of types we want to work with:
...
We cover how function template instantiation works in lesson [11.7 -- Function template instantiation][3].
...
Before proceeding, please review lessons [11.6 -- Function templates][2] and [11.7 -- Function template instantiation][3] if you're hazy on how function templates, template types, or function template instantiation works.
...
The above example makes use of a feature called class template specialization (covered in future lesson [26.4 -- Class template specialization][4]). Knowledge of how this feature works is not required at this point.
...
13.14Class template argument deduction (CTAD) and deduction guides

Back to table of contents

Previous lesson

13.12Member selection with pointers and references
  ...
  [4]: https://www.learncpp.com/cpp-tutorial/class-template-specialization/
