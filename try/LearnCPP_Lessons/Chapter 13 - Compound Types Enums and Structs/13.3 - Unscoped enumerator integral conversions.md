title: "13.3 — Unscoped enumerator integral conversions – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/unscoped-enumerator-integral-conversions/
...
# 13.3 â€" Unscoped enumerator integral conversions

[*Alex*][1] January 18, 2022, 10:20 am PST July 31, 2024

In the prior lesson ([13.2 -- Unscoped enumerations][2]), we mentioned that enumerators are symbolic constants. What we didn't tell you then is that these enumerators have values that are of an integral type.

This is similar to the case with chars ([4.11 -- Chars][3]). Consider:
...
We show how to convert an enumeration into a string in lesson [13.4 -- Converting an enumeration to and from a string][4].  
We teach `std::cout` how to print an enumerator in lesson [13.5 -- Introduction to overloading the I/O operators][5].
...
We'll see an example in lesson [13.4 -- Converting an enumeration to and from a string][4] where we make use of this.
...
13.2Unscoped enumerations
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/unscoped-enumerations/
  [3]: https://www.learncpp.com/cpp-tutorial/chars/
  [4]: https://www.learncpp.com/cpp-tutorial/converting-an-enumeration-to-and-from-a-string/
