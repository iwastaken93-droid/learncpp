title: "13.11 — Struct miscellany – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/struct-miscellany/
...
[*Alex*][1] July 21, 2023, 4:09 pm PDT September 25, 2024
...
This is more often done with classes, so we'll talk more about this in a future lesson ([15.3 -- Nested types (member types)][2]).

Structs that are owners should have data members that are owners

In lesson [5.9 -- std::string_view (part 2)][3], we introduced the dual concepts of owners and viewers. Owners manage their own data, and control when it is destroyed. Viewers view someone else's data, and do not control when it is altered or destroyed.
...
The reason compilers may add padding is beyond the scope of this tutorial, but readers who want to learn more can read about [data structure alignment][4] on Wikipedia. This is optional reading and not required to understand structures or C++!
...
13.10Passing and returning structs
  ...
  [6]: https://www.learncpp.com/cpp-tutorial/passing-and-returning-structs/
