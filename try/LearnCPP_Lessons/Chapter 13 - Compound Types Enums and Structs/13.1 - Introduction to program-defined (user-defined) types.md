title: "13.1 — Introduction to program-defined (user-defined) types – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/introduction-to-program-defined-user-defined-types/
...
[*Alex*][1] January 18, 2022, 10:17 am PST February 24, 2025
...
However, consider the case of a type alias (introduced in lesson [10.7 -- Typedefs and type aliases][2]), which allows us to define a new name for an existing type. Because a type alias introduces a new identifier into the program, a type alias must be defined before it can be used:
...
Back in the introduction to the previous chapter ([12.1 -- Introduction to compound data types][3]), we introduced the challenge of wanting to store a fraction, which has a numerator and denominator that are conceptually linked together. In that lesson, we discussed some of the challenges with using two separate integers to store a fraction's numerator and denominator independently.
...
We'll show more examples of defining and using program-defined types in the next lesson ([13.2 -- Unscoped enumerations][4]), and we cover structs starting in lesson
...
12.xChapter 12 summary and quiz
  ...
  [5]: https://www.learncpp.com/cpp-tutorial/forward-declarations/#ODR
  [6]: https://www.learncpp.com/
  [7]: https://www.learncpp.com/cpp-tutorial/chapter-12-summary-and-quiz/
