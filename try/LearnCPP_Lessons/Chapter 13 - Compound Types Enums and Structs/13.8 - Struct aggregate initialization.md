title: "13.8 — Struct aggregate initialization – Learn C++"
...
# 13.8 â€" Struct aggregate initialization

[*Alex*][1] January 18, 2022, 10:24 am PST January 6, 2025
...
To simplify a bit, an aggregate in C++ is either a C-style array ([17.7 -- Introduction to C-style arrays][2]), or a class type (struct, class, or union) that has:
- No user-declared constructors ([14.9 -- Introduction to constructors][3])
- No private or protected non-static data members ([14.5 -- Public and private members and access specifiers][4])
- No virtual functions ([25.2 -- Virtual functions and polymorphism][5])

The popular type `std::array` ([17.1 -- Introduction to std::array][6]) is also an aggregate.

You can find the precise definition of a C++ aggregate [here][7].
...
In lesson [13.5 -- Introduction to overloading the I/O operators][8], we showed how to overload `operator<<` to print an enumeration. It's also useful to overload `operator<<` for structs.
...
This is most commonly seen when initializing a struct with the return value of a function that returns a struct of the same type. We cover this in more detail in lesson [13.10 -- Passing and returning structs][9].

Next lesson

13.9Default member initialization
...
13.7Introduction to structs, members, and member selection
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/introduction-to-c-style-arrays/
  [3]: https://www.learncpp.com/cpp-tutorial/introduction-to-constructors/
  [4]: https://www.learncpp.com/cpp-tutorial/public-and-private-members-and-access-specifiers/
  [5]: https://www.learncpp.com/cpp-tutorial/virtual-functions/
  [6]: https://www.learncpp.com/cpp-tutorial/introduction-to-stdarray/
  [7]: https://en.cppreference.com/w/cpp/language/aggregate_initialization
  [8]: https://www.learncpp.com/cpp-tutorial/introduction-to-overloading-the-i-o-operators/
  [9]: https://www.learncpp.com/cpp-tutorial/passing-and-returning-structs/
  [10]: https://www.learncpp.com/cpp-tutorial/default-member-initialization/
