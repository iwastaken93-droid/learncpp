title: "13.5 — Introduction to overloading the I/O operators – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/introduction-to-overloading-the-i-o-operators/
...
[*Alex*][1] March 25, 2024, 2:51 pm PDT October 28, 2024

In the prior lesson ([13.4 -- Converting an enumeration to and from a string][2]), we showed this example, where we used a function to convert an enumeration into an equivalent string:
...
We cover operator overloading in much more detail in chapter [chapter 21][4].

For advanced readers

Operators can also be overloaded as member functions of the left-most operand. We discuss this in lesson [21.5 -- Overloading operators using member functions][5].
...
Our right operand (`pet`) is an out parameter. We cover out parameters in lesson [12.13 -- In and out parameters][6].
...
In lesson [17.6 -- std::array and enumerations][7], we show how we can use `std::array` to make our input and output operators less redundant, and avoid having to modify them when a new enumerator is added.

Next lesson

13.6Scoped enumerations (enum classes)

Back to table of contents

Previous lesson

13.4Converting an enumeration to and from a string

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/converting-an-enumeration-to-and-from-a-string/
  [3]: https://www.learncpp.com/cpp-tutorial/introduction-to-function-overloading/
  [4]: https://www.learncpp.com#Chapter21
  [5]: https://www.learncpp.com/cpp-tutorial/overloading-operators-using-member-functions/
  [6]: https://www.learncpp.com/cpp-tutorial/in-and-out-parameters/
  [7]: https://www.learncpp.com/cpp-tutorial/stdarray-and-enumerations/
  [8]: https://www.learncpp.com/cpp-tutorial/scoped-enumerations-enum-classes/
