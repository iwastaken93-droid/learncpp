title: "3.10 — Finding issues before they become problems – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/finding-issues-before-they-become-problems/
...
# 3.10 â€" Finding issues before they become problems

[*Alex*][1] February 1, 2019, 12:03 pm PST October 14, 2024
...
>
> â€"Brian Kernighan, "The Elements of Programming Styleâ€?, 2nd edition
...
One common method of doing this is via *assert* and *static_assert*, which we cover in lesson [9.6 -- Assert and static_assert][2].
...
You already have one static analysis tool at your disposal -- your compiler! In addition to ensuring your program is syntactically correct, most modern C++ compilers will do some light static analysis to identify some common problems. For example, many compilers will warn you if you try to use a variable that has not been initialized. If you haven't already, turning up your compiler warning and error levels (see lesson [0.11 -- Configuring your compiler: Warning and error levels][3]) can help surface these.

[Many static analysis tools exist][4], some of which can identify over 300 types of programming errors. On our small academic programs, use of a static analysis tool is optional, but using one may help you find areas where your code is non-compliant with best practices. On large programs, use of a static analysis tool is highly recommended, as it can surface tens or hundreds of potential issues.
...
- [clang-tidy][5]
- [cpplint][6]
- [cppcheck][7] (already integrated into Code::Blocks)
- [SonarLint][8]

Most of these have extensions that allow them to integrate into your IDE. For example, [Clang Power Tools extension][9].
...
3.9Using an integrated debugger: The call stack
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/assert-and-static_assert/
  [3]: https://www.learncpp.com/cpp-tutorial/configuring-your-compiler-warning-and-error-levels/
  [4]: https://en.wikipedia.org/wiki/List_of_tools_for_static_code_analysis#C,_C++
  [5]: https://clang.llvm.org/extra/clang-tidy/
  [6]: https://github.com/cpplint/cpplint
  [7]: https://cppcheck.sourceforge.io/
  [8]: https://www.sonarsource.com/open-source-editions/
  [9]: https://marketplace.visualstudio.com/items?itemName=caphyon.ClangPowerTools
  [10]: https://www.synopsys.com/software-integrity/security-testing/static-analysis-sast.html
  [11]: https://www.sonarsource.com/products/sonarqube/
  [12]: https://www.learncpp.com/cpp-tutorial/chapter-3-summary-and-quiz/
