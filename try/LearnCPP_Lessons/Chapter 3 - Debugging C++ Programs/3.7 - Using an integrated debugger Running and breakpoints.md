title: "3.7 — Using an integrated debugger: Running and breakpoints – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/using-an-integrated-debugger-running-and-breakpoints/
...
# 3.7 â€" Using an integrated debugger: Running and breakpoints

[*Alex*][1] February 1, 2019, 12:01 pm PST December 15, 2023

While stepping (covered in lesson [3.6 -- Using an integrated debugger: Stepping][2]) is useful for examining each individual line of your code in isolation, in a large program, it can take a long time to step through your code to even get to the point where you want to examine in more detail.
...
3.6Using an integrated debugger: Stepping
  ...
  [3]: https://www.learncpp.com/images/CppTutorial/Chapter3/VS-StepInto4-min.png
  [4]: https://www.learncpp.com/images/CppTutorial/Chapter3/VS-Breakpoint1-min.png
  [5]: https://www.learncpp.com/images/CppTutorial/Chapter3/VS-Breakpoint2-min.png
