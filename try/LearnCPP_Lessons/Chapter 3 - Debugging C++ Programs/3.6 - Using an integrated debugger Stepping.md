title: "3.6 — Using an integrated debugger: Stepping – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/using-an-integrated-debugger-stepping/
...
# 3.6 â€" Using an integrated debugger: Stepping

[*Alex*][1] November 16, 2007, 11:27 am PST August 30, 2024
...
Before proceeding with this lesson (and subsequent lessons related to using a debugger), make sure your project is compiled using a debug build configuration (see [0.9 -- Configuring your compiler: Build configurations][4] for more information).
...
If you don't want to continually add/remove/comment/uncomment the above, you can wrap the statement in a conditional compilation preprocessor directive (covered in lesson [2.10 -- Introduction to the preprocessor][10]):
...
3.5More debugging tactics
  ...
  [2]: https://en.wikipedia.org/wiki/Gdb
  [3]: https://en.wikipedia.org/wiki/Turbo_Debugger
  [4]: https://www.learncpp.com/cpp-tutorial/configuring-your-compiler-build-configurations/
  [5]: https://www.learncpp.com/images/CppTutorial/Chapter3/CB-DebuggingSetup-min.png
  [6]: https://www.learncpp.com/images/CppTutorial/Chapter3/VS2019-StepInto-Line9-min.png
  [7]: https://www.learncpp.com/images/CppTutorial/Chapter3/VS2019-StepInto-Line10-min.png
  [8]: https://www.learncpp.com/images/CppTutorial/Chapter3/VS2019-StepInto-Line4-min.png
  [9]: https://www.learncpp.com/images/CppTutorial/Chapter3/VS2019-StepInto-Line5-min.png
  [10]: https://www.learncpp.com/cpp-tutorial/introduction-to-the-preprocessor/
  [11]: https://github.com/rr-debugger/rr
  [12]: https://www.learncpp.com/
  [13]: https://www.learncpp.com/cpp-tutorial/more-debugging-tactics/
