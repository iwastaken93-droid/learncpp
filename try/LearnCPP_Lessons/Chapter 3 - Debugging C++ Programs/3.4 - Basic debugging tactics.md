title: "3.4 — Basic debugging tactics – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/basic-debugging-tactics/
...
# 3.4 â€" Basic debugging tactics

[*Alex*][1] February 1, 2019, 11:56 am PST December 30, 2024
...
We discuss when to use `std::cout` vs `std::cerr` further in lesson [9.4 -- Detecting and handling errors][4].
...
We discuss why some compilers print `1` vs an address (and what to do if your compiler prints `1` but you want it to print an address) in lesson [20.1 -- Function Pointers][5].
...
3.3A strategy for debugging
  ...
  [2]: https://github.com/sharkdp/dbg-macro/blob/master/dbg.h
  ...
  [6]: https://www.learncpp.com/cpp-tutorial/more-debugging-tactics/
  [7]: https://www.learncpp.com/
  [8]: https://www.learncpp.com/cpp-tutorial/a-strategy-for-debugging/
