title: "3.8 — Using an integrated debugger: Watching variables – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/using-an-integrated-debugger-watching-variables/
...
# 3.8 â€" Using an integrated debugger: Watching variables

[*Alex*][1] November 21, 2007, 9:58 am PST January 5, 2024

In the previous lessons ([3.6 -- Using an integrated debugger: Stepping][2] and [3.7 -- Using an integrated debugger: Running and breakpoints][3]), you learned how to use the debugger to watch the path of execution through your program. However, stepping through a program is only half of what makes the debugger useful. The debugger also lets you examine the value of variables as you step through your code, all without having to modify your code.
...
In case you are returning, make sure your project is compiled using a debug build configuration (see [0.9 -- Configuring your compiler: Build configurations][4] for more information). If you're compiling your project using a release configuration instead, the functionality of the debugger may not work correctly.
...
3.7Using an integrated debugger: Running and breakpoints
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/using-an-integrated-debugger-stepping/
  [3]: https://www.learncpp.com/cpp-tutorial/using-an-integrated-debugger-running-and-breakpoints/
  [4]: https://www.learncpp.com/cpp-tutorial/configuring-your-compiler-build-configurations/
  [5]: https://www.learncpp.com/images/CppTutorial/Chapter3/VS-Watch1-min.png
  [6]: https://www.learncpp.com/images/CppTutorial/Chapter3/CB-EvaluateExpression-min.png
  [7]: https://www.learncpp.com/images/CppTutorial/Chapter3/VS-Watch2-min.png
  [8]: https://www.learncpp.com/images/CppTutorial/Chapter3/VS-Watch3-min.png
  [9]: https://www.learncpp.com/images/CppTutorial/Chapter3/VS-QuickWatch1-min.png
  [10]: https://www.learncpp.com/images/CppTutorial/Chapter3/VS-QuickWatch2-min.png
  [11]: https://www.learncpp.com/images/CppTutorial/Chapter3/VS-Watch4-min.png
  [12]: https://www.learncpp.com/images/CppTutorial/Chapter3/VS-Watch5-min.png
  [13]: https://www.learncpp.com/images/CppTutorial/Chapter3/VS-Watch6-min.png
  [14]: https://www.learncpp.com/cpp-tutorial/using-an-integrated-debugger-the-call-stack/
