title: "14.7 — Member functions returning references to data members – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/member-functions-returning-references-to-data-members/
...
We cover `auto` return types in lesson [10.9 -- Type deduction for functions][3].
...
We covered what a full expression is in lesson [1.10 -- Introduction to expressions][4].
