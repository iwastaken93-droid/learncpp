title: "14.3 — Member functions – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/member-functions/
...
[*Alex*][1] August 30, 2007, 9:42 am PDT February 10, 2025
...
In this lesson, we'll use structs to show examples of member functions -- but everything we show here applies equally well to classes. For reasons that will become obvious when we get there, we'll show examples of classes with member functions in upcoming lesson ([14.5 -- Public and private members and access specifiers][2]).
...
We show how to define member functions outside the class type definition in lesson [15.2 -- Classes and header files][3].
...
Member functions can also be (forward) declared inside the class definition, and defined after the class definition. We cover this in lesson [15.2 -- Classes and header files][3].
...
We discuss a recommended order for member definition in upcoming lesson [14.8 -- The benefits of data hiding (encapsulation)][4].
...
We cover function overload differentiation in lesson [11.2 -- Function overload differentiation][5].
...
14.2Introduction to classes
  ...
  [5]: https://www.learncpp.com/cpp-tutorial/function-overload-differentiation/
  [6]: https://www.learncpp.com/cpp-tutorial/introduction-to-constructors/
  [7]: javascript:void(0)
