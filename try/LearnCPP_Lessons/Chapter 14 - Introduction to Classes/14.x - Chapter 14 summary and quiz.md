title: "14.x — Chapter 14 summary and quiz – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/chapter-14-summary-and-quiz/
...
# 14.x â€" Chapter 14 summary and quiz

[*Alex*][1] March 25, 2016, 6:01 pm PDT August 17, 2024
...
The blackjack quiz that used to be part of this lesson has been moved to lesson [17.x -- Chapter 17 summary and quiz][2].
...
In lesson [13.10 -- Passing and returning structs][4], we wrote a short program using a `Fraction` struct. The reference solution looks like this:
...
14.17Constexpr aggregates and classes
