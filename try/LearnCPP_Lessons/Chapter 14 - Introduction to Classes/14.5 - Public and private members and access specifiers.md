title: "14.5 — Public and private members and access specifiers – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/public-and-private-members-and-access-specifiers/
...
[*Alex*][1] September 4, 2007, 2:17 pm PDT July 3, 2024
...
We discuss the protected access level in the chapter on inheritance (lesson [24.5 -- Inheritance and access specifiers][2]).
...
So where does the third compilation error come from? Perhaps surprisingly, the initialization of `today` now causes a compilation error. In lesson [13.8 -- Struct aggregate initialization][3], we noted that an aggregate can have "no private or protected non-static data members.� Our `Date` class has private data members (because the members of classes are private by default), so our `Date` class does not qualify as an aggregate. Therefore, we can not use aggregate initialization to initialize it any more.

We'll discuss how to properly initialize classes (which are generally non-aggregates) in upcoming lesson [14.9 -- Introduction to constructors][4].
...
Classes should generally only have private (or protected) data members (either by using the default private access level, or the `private:` (or `protected:`) access specifier). We'll discuss the rationale for this in the next lesson [14.6 -- Access functions][5].
...
14.6Access functions

Back to table of contents

Previous lesson

14.4Const class objects and const member functions

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/inheritance-and-access-specifiers/
  ...
  [5]: https://www.learncpp.com/cpp-tutorial/access-functions/
  [6]: javascript:void(0)
