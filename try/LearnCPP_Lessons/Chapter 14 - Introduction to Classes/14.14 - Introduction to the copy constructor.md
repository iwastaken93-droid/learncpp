title: "14.14 — Introduction to the copy constructor – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/introduction-to-the-copy-constructor/
date: 2026-04-01 03:25
tags: 
description: 
...
# 14.14 â€" Introduction to the copy constructor

[*Alex*][1] November 4, 2007, 8:52 am PST December 19, 2024
...
We'll see cases where the copy constructor needs to be overwritten when we discuss dynamic memory allocation ([21.13 -- Shallow vs. deep copying][3]).
...
If you compile and execute the above example, you may find that only two calls to the copy constructor occur. This is a compiler optimization known as *copy elision*. We discuss copy elision further in lesson [14.15 -- Class initialization and copy elision][2].
...
You can also prevent the public from making copies of class object by making the copy constructor private (as private functions can't be used by the public). However, a private copy constructor *can* still be used by other members of the class, so this solution is not advised unless that is desired.
...
We discuss destructors in lesson [15.4 -- Introduction to destructors][5] and [19.3 -- Destructors][6], and copy assignment in lesson [21.12 -- Overloading the assignment operator][7].
...
14.15Class initialization and copy elision

Back to table of contents

Previous lesson

14.13Temporary class objects

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/class-initialization-and-copy-elision/
  [3]: https://www.learncpp.com/cpp-tutorial/shallow-vs-deep-copying/
  [4]: https://www.learncpp.com/cpp-tutorial/introduction-to-local-scope/
  [5]: https://www.learncpp.com/cpp-tutorial/introduction-to-destructors/
  ...
  [10]: https://www.learncpp.com/cpp-tutorial/temporary-class-objects/
