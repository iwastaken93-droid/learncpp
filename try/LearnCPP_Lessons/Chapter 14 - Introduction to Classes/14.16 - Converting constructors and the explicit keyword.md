title: "14.16 — Converting constructors and the explicit keyword – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/converting-constructors-and-the-explicit-keyword/
...
[*Alex*][1] June 5, 2016, 10:50 am PDT February 1, 2025

In lesson [10.1 -- Implicit type conversion][2], we introduced type conversion and the concept of implicit type conversion, where the compiler will implicitly convert a value of one type to a value of another type as needed if such a conversion exists.
