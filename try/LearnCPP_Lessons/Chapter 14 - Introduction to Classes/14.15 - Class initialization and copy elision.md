title: "14.15 — Class initialization and copy elision – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/class-initialization-and-copy-elision/
...
# 14.15 â€" Class initialization and copy elision

[*Alex*][1] June 5, 2016, 10:49 am PDT November 14, 2024

Way back in lesson [1.4 -- Variable assignment and initialization][2], we discuss 6 basic types of initialization for objects with fundamental types:
...
- Copy initialization only considers non-explicit constructors/conversion functions. We'll cover this in lesson [14.16 -- Converting constructors and the explicit keyword][3].
- List initialization prioritizes matching list constructors over other matching constructors. We'll cover this in lesson [16.2 -- Introduction to std::vector and list constructors][4].
...
We discussed the as-if rule in lesson [5.4 -- The as-if rule and compile-time optimization][5].
...
14.16Converting constructors and the explicit keyword

Back to table of contents

Previous lesson

14.14Introduction to the copy constructor
  ...
  [7]: https://www.learncpp.com/cpp-tutorial/introduction-to-the-copy-constructor/
