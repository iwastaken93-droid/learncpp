title: "14.17 — Constexpr aggregates and classes – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/constexpr-aggregates-and-classes/
...
# 14.17 â€" Constexpr aggregates and classes

[*Alex*][1] May 22, 2024, 4:43 pm PDT January 29, 2025

In lesson [F.1 -- Constexpr functions][2], we covered constexpr functions, which are functions that may be evaluated at either compile-time or runtime. For example:
...
We covered aggregates in lesson [13.8 -- Struct aggregate initialization][3].
...
The definition of a literal type is complex, and a summary can be found on [cppreference][4]. However, it's worth noting that literal types include:
