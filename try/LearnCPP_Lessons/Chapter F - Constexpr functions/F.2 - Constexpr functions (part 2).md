title: "F.2 — Constexpr functions (part 2) – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/constexpr-functions-part-2/
...
# F.2 â€" Constexpr functions (part 2)

[*Alex*][1] November 26, 2024, 4:16 pm PST December 10, 2024
...
In lesson [5.5 -- Constant expressions][2], we noted that in contexts that do not *require* a constant expression, the compiler may choose whether to evaluate a constant expression at either compile-time or at runtime. Accordingly, any constexpr function call that is part of a non-required constant expression may be evaluated at either compile-time or runtime.
...
This requirement was revoked in C++23 ([P2448R1][3]).
...
If you need parameters that are constant expressions, see [11.9 -- Non-type template parameters][4].
...
Per [CWG2166][5], the actual requirement for the forward declaration of constexpr functions that are evaluated at compile-time is that "the constexpr function must be defined prior to the outermost evaluation that eventually results in the invocation�. Therefore, this is allowed:
...
We cover the as-if rule in lesson [5.5 -- Constant expressions][2].
...
F.3Constexpr functions (part 3) and consteval

Back to table of contents

Previous lesson

F.1Constexpr functions

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/constant-expressions/
  [3]: https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2022/p2448r1.html
  [4]: https://www.learncpp.com/cpp-tutorial/non-type-template-parameters/
  [5]: https://www.open-std.org/jtc1/sc22/wg21/docs/cwg_active.html#2166
  [6]: https://www.learncpp.com/cpp-tutorial/constexpr-functions-part-3-and-consteval/
  [7]: https://www.learncpp.com/
  [8]: https://www.learncpp.com/cpp-tutorial/constexpr-functions/
