title: "F.3 — Constexpr functions (part 3) and consteval – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/constexpr-functions-part-3-and-consteval/
...
# F.3 â€" Constexpr functions (part 3) and consteval

[*Alex*][1] November 26, 2024, 4:49 pm PST March 5, 2025
...
There are several hacky ways that people have tried to work around the problem of having to introduce a new constexpr variable each time we want to force compile-time evaluation. See [here][2] and [here][3].
...
1.  As [the paper that proposed this feature][4] indicates, the standard doesn't actually make a distinction between "compile time� and "runtime�. Defining behavior involving that distinction would have been a larger change.
...
We cover lambdas in lesson [20.6 -- Introduction to lambdas (anonymous functions)][5].
...
We cover auto return types in lesson [10.9 -- Type deduction for functions][6].  
We cover abbreviated function templates (auto parameters) in lesson 11.8 -- Function templates with multiple template types [11.8 -- Function templates with multiple template types][7].

Next lesson

F.4Constexpr functions (part 4)

Back to table of contents

Previous lesson

F.2Constexpr functions (part 2)

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://quuxplusone.github.io/blog/2018/08/07/force-constexpr/
  [3]: https://artificial-mind.net/blog/2020/11/14/cpp17-consteval
  [4]: https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2018/p0595r2.html
  [5]: https://www.learncpp.com/cpp-tutorial/introduction-to-lambdas-anonymous-functions/
  ...
  [8]: https://www.learncpp.com/cpp-tutorial/constexpr-functions-part-4/
  [9]: https://www.learncpp.com/
  [10]: https://www.learncpp.com/cpp-tutorial/constexpr-functions-part-2/
