title: "11.3 — Function overload resolution and ambiguous matches – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/function-overload-resolution-and-ambiguous-matches/
...
We cover references in lesson [12.3 -- Lvalue references][3].
...
Step 3) If no match is found via numeric promotion, the compiler tries to find a match by applying numeric conversions ([10.3 -- Numeric conversions][5]) to the arguments.
...
We discuss how to create user-defined conversions for class types (by overloading the typecast operators) in lesson [21.11 -- Overloading typecasts][6].
...
We cover ellipses in lesson [20.5 -- Ellipsis (and why to avoid them)][7].
...
Default arguments can also cause ambiguous matches. We cover such cases in lesson [11.5 -- Default arguments][8].
...
The list of the most used suffixes can be found in lesson [5.2 -- Literals][9].
...
11.4Deleting functions

Back to table of contents

Previous lesson

11.2Function overload differentiation

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/function-overload-differentiation/
  [3]: https://www.learncpp.com/cpp-tutorial/lvalue-references/
  [4]: https://www.learncpp.com/cpp-tutorial/implicit-type-conversion/
  [5]: https://www.learncpp.com/cpp-tutorial/numeric-conversions/
  [6]: https://www.learncpp.com/cpp-tutorial/overloading-typecasts/
  [7]: https://www.learncpp.com/cpp-tutorial/ellipsis-and-why-to-avoid-them/
  [8]: https://www.learncpp.com/cpp-tutorial/default-arguments/
  [9]: https://www.learncpp.com/cpp-tutorial/literals/
  [10]: https://www.learncpp.com/cpp-tutorial/deleting-functions/
