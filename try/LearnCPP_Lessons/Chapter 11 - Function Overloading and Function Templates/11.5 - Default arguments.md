title: "11.5 — Default arguments – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/default-arguments/
...
# 11.5 â€" Default arguments

[*Alex*][1] August 6, 2007, 4:38 pm PDT November 10, 2024
...
We discuss function overload differentiation in lesson [11.2 -- Function overload differentiation][2]
...
We cover this topic in lesson [20.1 -- Function Pointers][3]. Because default arguments are not considered using this method, this also provides a workaround to call a function that would otherwise be ambiguous due to default arguments.
