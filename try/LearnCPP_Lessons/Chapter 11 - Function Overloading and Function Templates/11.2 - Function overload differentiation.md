title: "11.2 — Function overload differentiation – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/function-overload-differentiation/
...
[*Alex*][1] June 17, 2021, 5:43 pm PDT December 11, 2024

In the prior lesson ([11.1 -- Introduction to function overloading][2]), we introduced the concept of function overloading, which allows us to create multiple functions with the same name, so long as each identically named function has different parameter types (or the functions can be otherwise differentiated).
...
We cover ellipses in lesson [20.5 -- Ellipsis (and why to avoid them)][3].
...
11.1Introduction to function overloading
