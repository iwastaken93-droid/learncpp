title: "21.7 — Overloading the comparison operators – Learn C++"
...
# 21.7 â€" Overloading the comparison operators

[*Alex*][1] October 4, 2007, 5:10 pm PDT February 7, 2024

In lesson [6.7 -- Relational operators and floating point comparisons][2], we discussed the six comparison operators. Overloading these comparison operators is comparatively simple (see what I did there?), as they follow the same patterns as we've seen in overloading other operators.
...
If you need a refresher on std::sort, we talk about it in lesson [18.1 -- Sorting an array using selection sort][4].
...
21.6Overloading unary operators +, -, and !
  ...
  [3]: javascript:void(0)
  [4]: https://www.learncpp.com/cpp-tutorial/sorting-an-array-using-selection-sort/
  [5]: https://www.learncpp.com/
  [6]: https://www.learncpp.com/cpp-tutorial/overloading-unary-operators/
