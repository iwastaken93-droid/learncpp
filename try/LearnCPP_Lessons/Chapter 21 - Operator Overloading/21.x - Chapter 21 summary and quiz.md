title: "21.x — Chapter 21 summary and quiz – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/chapter-21-summary-and-quiz/
...
# 21.x â€" Chapter 21 summary and quiz

[*Alex*][1] August 9, 2016, 2:44 pm PDT December 28, 2024
...
binary `operator+` is best implemented as a normal/friend function.

b\) `-point`

[Show Solution][2]

unary `operator-` is best implemented as a member function.

c\) `std::cout << point`

[Show Solution][2]

`operator<<` must be implemented as a normal/friend function.
...
For variables `a` through `c`: [Show Hint][2]
...
21.yChapter 21 project

Back to table of contents

Previous lesson

21.14Overloading operators and function templates

  [1]: https://www.learncpp.com/author/Alex/
  [2]: javascript:void(0)
  [3]: https://www.learncpp.com/cpp-tutorial/chapter-21-project/
