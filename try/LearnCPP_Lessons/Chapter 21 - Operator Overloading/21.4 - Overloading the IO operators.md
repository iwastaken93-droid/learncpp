title: "21.4 — Overloading the I/O operators – Learn C++"
...
# 21.4 â€" Overloading the I:O operators

[*Alex*][1] October 1, 2007, 4:41 pm PDT January 29, 2025
...
In cases where `operator>>` simply fails to extract anything to a variable, `std::cin` will automatically be placed in failure mode (which we discuss in lesson [9.5 -- std::cin and handling invalid input][2]). The caller of this function can then check `std::cin` to see if it failed and handle that case as appropriate.
...
21.5Overloading operators using member functions

Back to table of contents

Previous lesson

21.3Overloading operators using normal functions

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/stdcin-and-handling-invalid-input/
  [3]: javascript:void(0)
  [4]: https://www.learncpp.com/cpp-tutorial/overloading-operators-using-member-functions/
