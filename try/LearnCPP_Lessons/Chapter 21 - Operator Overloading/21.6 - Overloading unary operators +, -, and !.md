title: "21.6 — Overloading unary operators +, -, and ! – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/overloading-unary-operators/
...
# 21.6 â€" Overloading unary operators +, -, and !

[*Alex*][1] October 8, 2007, 3:09 pm PDT November 25, 2023
...
1.  Implement overloaded unary `operator+` for the Point class. Unary `operator+` just returns its operand (it does not make negative values positive).
...
21.7Overloading the comparison operators
...
21.5Overloading operators using member functions
  ...
  [2]: javascript:void(0)
  [3]: https://www.learncpp.com/cpp-tutorial/overloading-the-comparison-operators/
