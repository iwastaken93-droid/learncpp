title: "21.12 — Overloading the assignment operator – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/overloading-the-assignment-operator/
...
# 21.12 â€" Overloading the assignment operator

[*Alex*][1] June 5, 2016, 10:51 am PDT July 22, 2024

The **copy assignment operator** (operator=) is used to copy values from one object to another *already existing object*.

Related content

As of C++11, C++ also supports "Move assignment�. We discuss move assignment in lesson [22.3 -- Move constructors and move assignment][2].
...
A better way to handle self-assignment issues is via what's called the copy and swap idiom. There's a great writeup of how this idiom works [on Stack Overflow][3].
...
21.13Shallow vs. deep copying

Back to table of contents

Previous lesson

21.11Overloading typecasts

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/move-constructors-and-move-assignment/
  [3]: https://stackoverflow.com/questions/3279543/what-is-the-copy-and-swap-idiom
  [4]: https://www.learncpp.com/cpp-tutorial/shallow-vs-deep-copying/
