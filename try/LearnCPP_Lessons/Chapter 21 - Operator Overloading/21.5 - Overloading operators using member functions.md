title: "21.5 — Overloading operators using member functions – Learn C++"
...
# 21.5 â€" Overloading operators using member functions

[*Alex*][1] October 11, 2007, 10:22 am PDT October 30, 2023
...
In the member function version, the expression `cents1 + 2` becomes function call `cents1.operator+(2)`. Note that there is now only one explicit function parameter, and cents1 has become an object prefix. However, in lesson

15.1 -- The hidden "this� pointer and member function chaining

, we mentioned that the compiler implicitly converts an object prefix into a hidden leftmost parameter named \*this. So in actuality, `cents1.operator+(2)` becomes `operator+(&​cents1, 2)`, which is almost identical to the friend version.
...
In lesson [21.4 -- Overloading the I/O operators][2], we overloaded operator\<\< for our Point class using the friend function method. Here's a reminder of how we did that:
...
21.6Overloading unary operators +, -, and !

Back to table of contents

Previous lesson

21.4Overloading the I/O operators

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/overloading-the-io-operators/
  [3]: https://www.learncpp.com/cpp-tutorial/overloading-unary-operators/
