title: "0.7 — Compiling your first program – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/compiling-your-first-program/
date: 2026-04-01 03:14
tags: 
description: 
...
# 0.7 â€" Compiling your first program

[*Alex*][1] May 28, 2007, 10:35 pm PDT January 21, 2025
...
Traditionally, the first program programmers write in a new language is the infamous [hello world program][3], and we aren't going to deprive you of that experience! You'll thank us later. Maybe.
...
Select *Windows Desktop Wizard* and click *Next*. If you don't see this, then you probably forgot to choose to install the *Desktop development with C++* workload when you installed Visual Studio. In that case, go back to lesson

0.6 -- Installing an Integrated Development Environment (IDE)

and reinstall your Visual Studio as indicated (note: rather than doing a full reinstall, you can run the Visual Studio installer and modify your existing installation to add the C++ workload).
...
You've now created a project! Jump down to the [Visual Studio Solution Explorer][8] section below to continue.
...
First, make sure *Visual C++* is listed on the left side. If you don't see *Visual C++*, then you probably forgot to choose to install the *Desktop development with C++* workload when you installed Visual Studio. In that case, go back to lesson

0.6 -- Installing an Integrated Development Environment (IDE)

and reinstall your Visual Studio as indicated (note: rather doing a full reinstall, you can run the Visual Studio installer and modify your existing install to add the C++ workload).
...
You forgot to turn off precompiled headers when you created your project. Recreate your project (as per the [instructions above][12]) and make sure to disable precompiled headers.
...
This is normal. Visual Studio is providing some additional information about whether your program exited normally or abnormally. We discuss this further in lesson [2.2 -- Function return values (value-returning functions)][14].
...
Linux users may need to install the additional packages before Code::Blocks will compile. Please see the Code::Blocks installation instructions in lesson
...
Second, look at the Q&A in lesson [0.8 -- A few common C++ problems][18], as your issue may be covered there.
...
In lesson [0.5 -- Introduction to the compiler, linker, and libraries][19], we showed that to produce an executable that can be run, each code file in a program is compiled into an object file, and then the object files are linked into an executable.
...
0.6Installing an Integrated Development Environment (IDE)
  ...
  [2]: https://www.learncpp.com/images/CppTutorial/Chapter0/WindowsCommandLine-min.png
  [3]: https://en.wikipedia.org/wiki/Hello_world
  [4]: https://www.learncpp.com/images/CppTutorial/Chapter0/VS2019-GetStarted-min.png
  [5]: https://www.learncpp.com/images/CppTutorial/Chapter0/VS2019-CreateNewProject-min.png
  [6]: https://www.learncpp.com/images/CppTutorial/Chapter0/VS2019-ConfigureNewProject-min.png
  [7]: https://www.learncpp.com/images/CppTutorial/Chapter0/VS2019-PrecompiledHeader-min.png
  [8]: https://www.learncpp.com/cpp-tutorial/compiling-your-first-program#visual_studio_solution_explorer
  [9]: https://www.learncpp.com/images/CppTutorial/Chapter0/VS2017-NewProject-min.png
  [10]: https://www.learncpp.com/images/CppTutorial/Chapter0/VS2017-DesktopWizard-min.png
  [11]: https://www.learncpp.com/images/CppTutorial/Chapter0/VS2019-Initial-min.png
  [12]: https://www.learncpp.com/cpp-tutorial/compiling-your-first-program#creating_project_vs19
  [13]: https://www.learncpp.com/images/CppTutorial/Chapter0/VC2005-Run-min.png
  [14]: https://www.learncpp.com/cpp-tutorial/function-return-values-value-returning-functions/
  [15]: https://www.learncpp.com/images/CppTutorial/Chapter0/CB-Project-min.png
  [16]: https://www.learncpp.com/images/CppTutorial/Chapter0/CB2017-Save-min.png
  [17]: https://www.learncpp.com/images/CppTutorial/Chapter0/CB-Closed-min.png
  [18]: https://www.learncpp.com/cpp-tutorial/a-few-common-cpp-problems/
  [19]: https://www.learncpp.com/cpp-tutorial/introduction-to-the-compiler-linker-and-libraries/
  [20]: https://www.learncpp.com/
