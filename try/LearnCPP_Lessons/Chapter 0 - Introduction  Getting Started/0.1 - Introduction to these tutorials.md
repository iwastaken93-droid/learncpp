title: "0.1 — Introduction to these tutorials – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/introduction-to-these-tutorials/
...
# 0.1 â€" Introduction to these tutorials

[*Alex*][1] May 27, 2007, 8:50 am PDT February 23, 2025
...
- Ask your question on a site that is designed for programming Q&A, like [Stack Overflow][2].
...
Use our [Site index][3] to look up any topics you want to know more about there, and you'll find links to the lessons where that topic is discussed. The site index is also accessible from every lesson via a link in the title bar.

You might also try [this glossary of C++ terms][4], provided by Bjarne Stroustrup (the creator of C++).
...
Not easily, but you can! See [darkreader.org][5].
...
0.2Introduction to programs and programming languages
...
No previous lesson
  ...
  [3]: https://www.learncpp.com/learn-c-site-index/
  [4]: https://www.stroustrup.com/glossary.html
  [5]: https://darkreader.org/
  [6]: https://www.learncpp.com/
  [7]: https://www.learncpp.com/cpp-tutorial/introduction-to-these-tutorials#

*Previous Post*[Welcome to LearnCpp.com!][8]

  [8]: https://www.learncpp.com/site-news/this-is-a-news-test-post/

*Next Post*[0.2 â€" Introduction to programs and programming languages][9]

  [9]: https://www.learncpp.com/cpp-tutorial/introduction-to-programming-languages/
