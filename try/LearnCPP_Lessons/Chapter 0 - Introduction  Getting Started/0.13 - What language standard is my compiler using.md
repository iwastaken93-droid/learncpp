title: "0.13 — What language standard is my compiler using? – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/what-language-standard-is-my-compiler-using/
...
# 0.13 â€" What language standard is my compiler using?

[*Alex*][1] April 18, 2024, 10:29 am PDT December 29, 2024
...
If you get an error while trying to build this, you may have your project set up incorrectly. See [0.8 -- A few common C++ problems][2] for advice on some common issues. If that does not help, review the lessons starting from
...
0.12Configuring your compiler: Choosing a language standard
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/a-few-common-cpp-problems/
  [3]: https://www.learncpp.com/cpp-tutorial/statements-and-the-structure-of-a-program/
  [4]: https://www.learncpp.com/

*Previous Post*[13.5 â€" Introduction to overloading the I/O operators][5]

  [5]: https://www.learncpp.com/cpp-tutorial/introduction-to-overloading-the-i-o-operators/

*Next Post*[14.17 â€" Constexpr aggregates and classes][6]

  [6]: https://www.learncpp.com/cpp-tutorial/constexpr-aggregates-and-classes/
