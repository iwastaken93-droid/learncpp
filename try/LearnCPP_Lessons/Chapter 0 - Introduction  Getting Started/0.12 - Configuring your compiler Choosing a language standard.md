title: "0.12 — Configuring your compiler: Choosing a language standard – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/configuring-your-compiler-choosing-a-language-standard/
...
# 0.12 â€" Configuring your compiler: Choosing a language standard

[*Alex*][1] November 12, 2019, 6:26 pm PST February 27, 2025
...
For more information on Visual Studio language standard settings, Microsoft has a [Visual Studio language standard reference document][3].
...
We recommend updating your compiler by updating MinGW. The procedure to do so can be found under the Code::Blocks section in lesson
...
This has been moved to the next lesson. See [0.13 -- What language standard is my compiler using?][6].
...
Feb 2025: Reader Mingtao Yue kindly [left a comment][7] providing some workarounds to a couple of bugs in this feature.
...
The approved C++ standards document for a given language standard is not available for free. There is a link to purchase the latest standard [here][8].

When a new language standard is being developed, draft standards documents are published for review. These drafts *are* available online for free. The last draft standard before the approved standard is generally close enough to the official standard to use for most purposes. You can find the draft standards [here][9].
...
- Your compiler is configured to use an older language standard that doesn't support the feature you are using. Try selecting a newer language standard and compile your program again. You can use the program in lesson [0.13 -- What language standard is my compiler using?][6] to validate that you have configured your language standard selection correctly.
- The version of the compiler you are running may have missing, partial, or buggy support for a feature you are using.

The CPPReference website tracks compiler support for each feature per language standard. You can find those support tables linked from their [home page][10], top right, under "Compiler Support� (by language standard). For example, you can see which C++23 features are supported [here][11].
...
0.13What language standard is my compiler using?
...
0.11Configuring your compiler: Warning and error levels
  ...
  [2]: https://www.learncpp.com/images/CppTutorial/Chapter0/VS2019-Project-Language-min.png
  [3]: https://docs.microsoft.com/en-us/cpp/build/reference/std-specify-language-standard-version?view=msvc-160
  [4]: https://www.learncpp.com/images/CppTutorial/Chapter0/CB-SettingsCompiler-min.png
  [5]: https://www.learncpp.com/images/CppTutorial/Chapter0/CB-C++11-min.png
  [6]: https://www.learncpp.com/cpp-tutorial/what-language-standard-is-my-compiler-using/
  [7]: https://www.learncpp.com/cpp-tutorial/configuring-your-compiler-choosing-a-language-standard/#comment-607992
  [8]: https://isocpp.org/std/the-standard
  [9]: https://www.open-std.org/jtc1/sc22/wg21/docs/standards
  [10]: https://en.cppreference.com/w/cpp
  [11]: https://en.cppreference.com/w/cpp/compiler_support/23
