title: "0.6 — Installing an Integrated Development Environment (IDE) – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/installing-an-integrated-development-environment-ide/
...
[*Alex*][1] May 28, 2007, 6:18 pm PDT January 29, 2025
...
If you are developing on a Windows 10 or 11 machine, then we strongly recommend downloading [Visual Studio 2022 Community][2].
...
If you are developing on Linux (or you are developing on Windows but want to write programs that you can easily port to Linux), we recommend [Code::Blocks][4]. Code::Blocks is a free, open source, cross-platform IDE that will run on both Linux and Windows.
...
VS Code should be downloaded using your distribution's package manager. The [VS Code instructions for linux][8] cover how to do this for various Linux distributions.

Once VS Code is installed, follow the [instructions on how to configure C++ for linux][9].

For Mac users

The [VS Code instructions for Mac][10] detail how to install and setup VS Code for macOS.

Once VS Code is installed, follow the [instructions on how to configure C++ for Mac][11].

For Windows users

The [VS Code instructions for Windows][12] detail how to install and setup VS Code for Windows.

Once VS Code is installed, follow the [instructions on how to configure C++ for Windows][13].

Other macOS IDEs

Other popular Mac choices include [Xcode][14] (if it is available to you) and the [Eclipse][15] code editor. Eclipse is not set up to use C++ by default, and you will need to install the optional C++ components.
...
- [TutorialsPoint][16]
- [Wandbox][17] (can choose different versions of GCC or Clang)
- [Godbolt][18] (can see assembly)
...
0.5Introduction to the compiler, linker, and libraries
  ...
  [3]: https://www.learncpp.com/images/CppTutorial/Chapter0/VS2019-Installer-min.png
  [4]: https://www.codeblocks.org/downloads/binaries/
  [5]: https://www.learncpp.com/blog/wp-content/uploads/images/CppTutorial/ide/CB-MinGWDownload-min.png
  [6]: https://www.learncpp.com/images/CppTutorial/Chapter0/CompilersAutoDetection-min.png
  [7]: http://wiki.codeblocks.org/index.php/Installing_a_supported_compiler
  [8]: https://code.visualstudio.com/docs/setup/linux
  [9]: https://code.visualstudio.com/docs/cpp/config-linux
  [10]: https://code.visualstudio.com/docs/setup/mac
  [11]: https://code.visualstudio.com/docs/cpp/config-clang-mac
  [12]: https://code.visualstudio.com/docs/setup/windows
  [13]: https://code.visualstudio.com/docs/cpp/config-mingw
  [14]: https://developer.apple.com/xcode/
  [15]: https://www.eclipse.org/
  [16]: https://www.tutorialspoint.com/compile_cpp_online.php
  [17]: https://wandbox.org/
  [18]: https://godbolt.org/
  [19]: https://www.learncpp.com/cpp-tutorial/compiling-your-first-program/
