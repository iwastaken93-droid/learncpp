title: "0.4 — Introduction to C++ development – Learn C++"
...
# 0.4 â€" Introduction to C++ development

[*Alex*][1] May 27, 2007, 8:10 pm PDT October 17, 2024
...
The term *bug* was first used by Thomas Edison back in the 1870s! However, the term was popularized in the 1940s when engineers found an actual moth stuck in the hardware of an early computer, causing a short circuit. Both the log book in which the error was reported and the moth are now part of the Smithsonian Museum of American History. It can be viewed [here][3].
...
[Coding Font][5] and [Programming Fonts][6] both have neat tools that allow you to compare different coding fonts to see which ones you like best.
...
0.3Introduction to C/C++
  ...
  [2]: https://www.learncpp.com/images/CppTutorial/Chapter0/Development-min.png
  [3]: https://americanhistory.si.edu/collections/nmah_334663
  [4]: https://web.archive.org/web/20120313070806/http://users.jyu.fi/~koskinen/smcosts.htm
