title: "0.2 — Introduction to programs and programming languages – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/introduction-to-programming-languages/
...
# 0.2 â€" Introduction to programs and programming languages

[*Alex*][1] May 27, 2007, 10:42 am PDT March 20, 2025
...
A "CPU family� is formally called an "instruction set architecture� ("ISA� for short). Wikipedia has a list of different CPU families [here][2].
...
A good comparison of the advantages of compilers vs interpreters can be found [here][5].
...
- In certain cases, the C++ language allows the compiler to determine how something should behave. We discuss this further in lesson [1.6 -- Uninitialized variables and undefined behavior][7] under "implementation-defined behavior�.
...
0.1Introduction to these tutorials
  ...
  [2]: https://en.wikipedia.org/wiki/Comparison_of_instruction_set_architectures#Instruction_sets
  [3]: https://www.learncpp.com/images/CppTutorial/Chapter0/Compiling-min.png
  [4]: https://www.learncpp.com/images/CppTutorial/Chapter0/Interpreting-min.png
  [5]: https://stackoverflow.com/a/38491646
  [6]: https://www.learncpp.com/images/CppTutorial/Chapter0/Portability-min.png
  [7]: https://www.learncpp.com/cpp-tutorial/uninitialized-variables-and-undefined-behavior/
  [8]: https://www.learncpp.com/cpp-tutorial/introduction-to-cplusplus/
  [9]: https://www.learncpp.com/
  [10]: https://www.learncpp.com/cpp-tutorial/introduction-to-these-tutorials/
