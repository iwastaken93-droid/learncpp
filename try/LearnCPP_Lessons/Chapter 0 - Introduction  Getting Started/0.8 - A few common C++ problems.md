title: "0.8 — A few common C++ problems – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/a-few-common-cpp-problems/
...
# 0.8 â€" A few common C++ problems

[*Alex*][1] December 16, 2007, 12:11 am PST December 19, 2024
...
c) When you compile your program, do you see the file that contains function main() get compiled? If not, either move the main() function to one that is, or add the file to your project (see lesson [2.8 -- Programs with multiple code files][2] for more information about how to do this).  
...
Our suggested fix is to turn off precompiled headers, which we show how to do in lesson [0.7 -- Compiling your first program][3].
...
Second, **ask an AI** like [ChatGPT via Bing][4]. Start your question with "In C++,� to get a C++ specific answer. Some ideas for things you can ask for:
...
If the above fails, **ask on a Q&A board**. There are websites designed for programming questions and answers, like [Stack Overflow][5]. Try posting your question there. Remember to be thorough about what your problem is, and include all relevant information like what OS you're on and what IDE you're using.
...
0.7Compiling your first program
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/programs-with-multiple-code-files/
  [3]: https://www.learncpp.com/cpp-tutorial/compiling-your-first-program/
  [4]: https://www.bing.com/chat
