title: "6.2 — Arithmetic operators – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/arithmetic-operators/
...
# 6.2 â€" Arithmetic operators

[*Alex*][1] June 13, 2007, 5:14 pm PDT February 14, 2025
...
In lesson [4.12 -- Introduction to type conversion and static_cast][2], we showed how we could use the *static_cast\<\>* operator to convert a char into an integer so it would print as an integer rather than a character.
...
We discuss `NaN` and `Inf` in lesson [4.8 -- Floating point numbers][3].
...
- The increment and decrement operators (`++` and `--` respectively). We discuss these in lesson [6.4 -- Increment/decrement operators, and side effects][4].

Excluded from this list are operators `==`, `!=`, `<=`, and `>=`, as these are non-modifying relational (comparison) operators (the `=` means "is equal to�). We discuss these in lesson [6.7 -- Relational operators and floating point comparisons][5].
...
6.3Remainder and Exponentiation
...
6.1Operator precedence and associativity
  ...
  [4]: https://www.learncpp.com/cpp-tutorial/increment-decrement-operators-and-side-effects/
  [5]: https://www.learncpp.com/cpp-tutorial/relational-operators-and-floating-point-comparisons/
  [6]: https://www.learncpp.com/cpp-tutorial/remainder-and-exponentiation/
  [7]: https://www.learncpp.com/
  [8]: https://www.learncpp.com/cpp-tutorial/operator-precedence-and-associativity/
