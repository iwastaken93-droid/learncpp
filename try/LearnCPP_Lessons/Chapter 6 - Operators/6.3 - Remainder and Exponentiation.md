title: "6.3 — Remainder and Exponentiation – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/remainder-and-exponentiation/
...
[*Alex*][1] August 17, 2019, 11:57 am PDT December 30, 2024
...
You'll note that the *\^* operator (commonly used to denote exponentiation in mathematics) is a *Bitwise XOR* operation in C++ (covered in lesson [O.3 -- Bit manipulation with bitwise operators and bit masks][2]). C++ does not include an exponent operator.
...
We cover asserts in lesson [9.6 -- Assert and static_assert][3], and constexpr functions in lesson [F.1 -- Constexpr functions][4].
...
Hint: You may need to use if-statements and the comparison operator (==) for this program. See lesson [4.9 -- Boolean values][6] if you need a refresher on how to do this.
...
6.2Arithmetic operators
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/bit-manipulation-with-bitwise-operators-and-bit-masks/
  [3]: https://www.learncpp.com/cpp-tutorial/assert-and-static_assert/
  [4]: https://www.learncpp.com/cpp-tutorial/constexpr-functions/
  [5]: javascript:void(0)
  [6]: https://www.learncpp.com/cpp-tutorial/boolean-values/
