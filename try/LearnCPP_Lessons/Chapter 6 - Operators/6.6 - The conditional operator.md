title: "6.6 — The conditional operator – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/the-conditional-operator/
...
[*Alex*][1] October 23, 2023, 1:42 pm PDT February 14, 2025
...
We cover if-else statements in lesson [4.10 -- Introduction to if statements][2].
...
We cover the way that C++ prioritizes the evaluation of operators in future lesson [6.1 -- Operator precedence and associativity][3].
...
Alternatively, one or both of the second and third operands is allowed to be a throw expression. We cover `throw` in lesson [27.2 -- Basic exception handling][4].
...
The surprising case above related to mixing signed and unsigned values is due to the arithmetic conversion rules, which we cover in lesson [10.5 -- Arithmetic conversions][5].
...
Since we haven't covered `if constexpr` yet (we do so in lesson [8.4 -- Constexpr if statements][6]), `x` is non-constexpr in this example to avoid the potential compiler warning.
...
6.5The comma operator

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/introduction-to-if-statements/
  [3]: https://www.learncpp.com/cpp-tutorial/operator-precedence-and-associativity/
  [4]: https://www.learncpp.com/cpp-tutorial/basic-exception-handling/
  [5]: https://www.learncpp.com/cpp-tutorial/arithmetic-conversions/
  [6]: https://www.learncpp.com/cpp-tutorial/constexpr-if-statements/
  [7]: https://www.learncpp.com/
  [8]: https://www.learncpp.com/cpp-tutorial/the-comma-operator/
