title: "6.8 — Logical operators – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/logical-operators/
...
[*Alex*][1] June 15, 2007, 1:35 pm PDT November 26, 2024
...
You have already run across the logical NOT unary operator in lesson [4.9 -- Boolean values][2]. We can summarize the effects of logical NOT like so:
...
New programmers sometimes confuse the *logical OR* operator (\|\|) with the *bitwise OR* operator (\|) (covered in lesson [O.2 -- Bitwise operators][3]). Even though they both have *OR* in the name, they perform different functions. Mixing them up will probably lead to incorrect results.
...
[De Morgan's laws][4] tell us how the *logical NOT* should be distributed in these cases:
...
The full list can be found [here][5]. Of particular note are the following three:
...
In lesson [6.3 -- Remainder and Exponentiation][7], we wrote a function to determine whether a number is even that looked like this:
...
6.7Relational operators and floating point comparisons

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/boolean-values/
  [3]: https://www.learncpp.com/cpp-tutorial/bitwise-operators/
  [4]: https://en.wikipedia.org/wiki/De_Morgan%27s_laws
  [5]: https://en.cppreference.com/w/cpp/language/operator_alternative
  [6]: javascript:void(0)
  [7]: https://www.learncpp.com/cpp-tutorial/remainder-and-exponentiation/
  [8]: https://www.learncpp.com/cpp-tutorial/chapter-6-summary-and-quiz/
