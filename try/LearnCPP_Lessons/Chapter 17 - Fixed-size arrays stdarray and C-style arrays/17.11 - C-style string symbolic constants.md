title: "17.11 — C-style string symbolic constants – Learn C++"
...
# 17.11 â€" C-style string symbolic constants

[*Alex*][1] August 15, 2015, 4:46 pm PDT October 25, 2023

In the previous lesson ([17.10 -- C-style strings][2]), we discussed how to create and initialize C-style string objects:
...
We cover `void*` in lesson [19.5 -- Void pointers][3]. You don't need to know how it works to use it here.
...
17.10C-style strings
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/c-style-strings/
  [3]: https://www.learncpp.com/cpp-tutorial/void-pointers/
  [4]: https://www.learncpp.com/cpp-tutorial/multidimensional-c-style-arrays/
