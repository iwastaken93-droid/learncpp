title: "17.6 — std::array and enumerations – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/stdarray-and-enumerations/
...
# 17.6 â€" std::array and enumerations

[*Alex*][1] September 11, 2023, 3:52 pm PDT February 1, 2025

In lesson [16.9 -- Array indexing and length using enumerators][2], we discussed arrays and enumerations.
...
In lesson [13.5 -- Introduction to overloading the I/O operators][3], we covered a few ways to input and output the names of enumerators. To assist in this task, we had helper functions that converted an enumerator to a string and vice-versa. These functions each had their own (duplicate) set of string literals, and we had to specifically code logic to check each:
...
17.7Introduction to C-style arrays

Back to table of contents

Previous lesson

17.5Arrays of references via std::reference_wrapper

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/array-indexing-and-length-using-enumerators/
  [3]: https://www.learncpp.com/cpp-tutorial/introduction-to-overloading-the-i-o-operators/
  [4]: javascript:void(0)
  [5]: https://www.learncpp.com/cpp-tutorial/introduction-to-c-style-arrays/
