title: "17.8 — C-style array decay – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/c-style-array-decay/
...
# 17.8 â€" C-style array decay

[*Alex*][1] July 11, 2007, 6:20 pm PDT January 17, 2025
...
We'll see where this is convenient in a moment, and take a deeper look at how this actually works (as well as what happens when the pointer is holding something other than the address of the first element) in the next lesson [17.9 -- Pointer arithmetic and subscripting][2].
...
Hint: Consider the case where we are printing a string using `std::cout`.
...
17.9Pointer arithmetic and subscripting
...
17.7Introduction to C-style arrays
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/pointer-arithmetic-and-subscripting/
  [3]: https://www.learncpp.com/cpp-tutorial/introduction-to-c-style-arrays/
  [4]: javascript:void(0)
