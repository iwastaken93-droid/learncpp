title: "5.1 — Constant variables (named constants) – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/constant-variables-named-constants/
...
# 5.1 â€" Constant variables (named constants)

[*Alex*][1] February 23, 2015, 5:13 pm PST October 17, 2024
...
We'll start our coverage of constants by looking at named constants. We will then cover literal constants (in upcoming lesson [5.2 -- Literals][2]).
...
- Object-like macros with substitution text (introduced in lesson [2.10 -- Introduction to the preprocessor][3], with additional coverage in this lesson).
- Enumerated constants (covered in lesson [13.2 -- Unscoped enumerations][4]).
...
In lesson [2.10 -- Introduction to the preprocessor][3], we discussed object-like macros with substitution text. For example:
...
There are multiple ways to facilitate this within C++ -- we cover this topic in full detail in lesson
...
4.xChapter 4 summary and quiz
  ...
  [5]: https://x.com/jfbastien/status/1017819242815631360
  [6]: https://www.learncpp.com/
  [7]: https://www.learncpp.com/cpp-tutorial/chapter-4-summary-and-quiz/
