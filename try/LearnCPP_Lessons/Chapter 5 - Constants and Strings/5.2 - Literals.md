title: "5.2 — Literals – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/literals/
...
[*Alex*][1] June 9, 2007, 10:43 pm PDT March 17, 2025
...
The `s` and `sv` suffixes require an additional line of code to use. We cover these further in lessons [5.7 -- Introduction to std::string][2] and [5.8 -- Introduction to std::string_view][3].

Additional (rarely used) suffixes exist for complex numbers and chrono (time) literals. These are documented [here][4].

For advanced readers

Excepting the `f` suffix, suffixes are most often used in cases where type deduction is involved. See [10.8 -- Type deduction for objects using the auto keyword][5] and
...
We discuss `std::string` and `std::string_view` literals in lesson [5.7 -- Introduction to std::string][2] and [5.8 -- Introduction to std::string_view][3] respectively.
...
Avoid magic numbers in your code (use constexpr variables instead, see lesson [5.6 -- Constexpr variables][6]).
...
5.1Constant variables (named constants)

  [1]: https://www.learncpp.com/author/Alex/
  [2]: https://www.learncpp.com/cpp-tutorial/introduction-to-stdstring/
  [3]: https://www.learncpp.com/cpp-tutorial/introduction-to-stdstring_view/
  [4]: https://en.cppreference.com/w/cpp/symbol_index/literals
  [5]: https://www.learncpp.com/cpp-tutorial/type-deduction-for-objects-using-the-auto-keyword/
  [6]: https://www.learncpp.com/cpp-tutorial/constexpr-variables/
  [7]: https://www.learncpp.com/
  [8]: https://www.learncpp.com/cpp-tutorial/constant-variables-named-constants/
