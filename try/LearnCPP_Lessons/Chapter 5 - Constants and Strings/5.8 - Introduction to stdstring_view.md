title: "5.8 — Introduction to std::string_view – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/introduction-to-stdstring_view/
...
# 5.8 â€" Introduction to std::string_view

[*nascardriver*][1] November 2, 2019, 7:17 am PDT November 26, 2024
...
We discuss this use of `using namespace` in lesson [5.7 -- Introduction to std::string][2]. The same advice applies here.
