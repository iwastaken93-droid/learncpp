title: "5.6 — Constexpr variables – Learn C++"
source: https://www.learncpp.com/cpp-tutorial/constexpr-variables/
...
# 5.6 â€" Constexpr variables

[*Alex*][1] October 23, 2023, 1:58 pm PDT February 5, 2025

In the previous lesson [5.5 -- Constant expressions][2], we defined what a constant expression is, discussed why constant expressions are desirable, and concluded with when constant expressions actually evaluate at compile-time.
...
We talk about functions whose return values can be used in constant expressions in lesson [F.1 -- Constexpr functions][3].
...
C++ also supports a way to pass compile-time constants to a function. We discuss these in lesson [11.9 -- Non-type template parameters][4].
...
We used to discuss constexpr functions in detail in this chapter, but feedback from readers indicated that the topic was too long and nuanced to present this early in the tutorial series. As a result, we've moved the full discussion back to lesson [F.1 -- Constexpr functions][3].
...
5.5Constant expressions
  ...
  [2]: https://www.learncpp.com/cpp-tutorial/constant-expressions/#whywecare
  ...
  [7]: https://www.learncpp.com/cpp-tutorial/constant-expressions/
